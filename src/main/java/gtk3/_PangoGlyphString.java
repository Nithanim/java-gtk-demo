...
public class _PangoGlyphString {
    ...
    public static MemoryAddress glyphs$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoGlyphString.glyphs$VH.get(seg);
    }
    ...
    public static MemoryAddress glyphs$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoGlyphString.glyphs$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress log_clusters$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoGlyphString.log_clusters$VH.get(seg);
    }
    ...
    public static MemoryAddress log_clusters$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoGlyphString.log_clusters$VH.get(seg.asSlice(index*sizeof()));
    }
