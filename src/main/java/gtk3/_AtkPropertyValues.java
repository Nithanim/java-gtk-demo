...
public class _AtkPropertyValues {
    ...
    public static MemoryAddress property_name$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkPropertyValues.property_name$VH.get(seg);
    }
    ...
    public static MemoryAddress property_name$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkPropertyValues.property_name$VH.get(seg.asSlice(index*sizeof()));
    }
