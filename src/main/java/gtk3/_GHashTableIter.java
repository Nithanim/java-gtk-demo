...
public class _GHashTableIter {
    ...
    public static MemoryAddress dummy1$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GHashTableIter.dummy1$VH.get(seg);
    }
    ...
    public static MemoryAddress dummy1$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GHashTableIter.dummy1$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress dummy2$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GHashTableIter.dummy2$VH.get(seg);
    }
    ...
    public static MemoryAddress dummy2$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GHashTableIter.dummy2$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress dummy3$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GHashTableIter.dummy3$VH.get(seg);
    }
    ...
    public static MemoryAddress dummy3$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GHashTableIter.dummy3$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress dummy6$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GHashTableIter.dummy6$VH.get(seg);
    }
    ...
    public static MemoryAddress dummy6$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GHashTableIter.dummy6$VH.get(seg.asSlice(index*sizeof()));
    }
