...
class constants$364 {
    ...
    static final MethodHandle pthread_barrierattr_getpshared$MH = RuntimeHelper.downcallHandle(
        ...
        constants$364.pthread_barrierattr_getpshared$FUNC, false
    );
    ...
    static final MethodHandle pthread_barrierattr_setpshared$MH = RuntimeHelper.downcallHandle(
        ...
        constants$364.pthread_barrierattr_setpshared$FUNC, false
    );
    ...
    static final MethodHandle pthread_key_create$__destr_function$MH = RuntimeHelper.downcallHandle(
        constants$364.pthread_key_create$__destr_function$FUNC, false
    );
    ...
    static final MethodHandle pthread_key_create$MH = RuntimeHelper.downcallHandle(
        "pthread_key_create",
        constants$364.pthread_key_create$FUNC, false
    );
    ...
    static final MethodHandle pthread_key_delete$MH = RuntimeHelper.downcallHandle(
        "pthread_key_delete",
        constants$364.pthread_key_delete$FUNC, false
    );
}
