...
class constants$148 {
    ...
    static final MethodHandle g_hook_find_data$MH = RuntimeHelper.downcallHandle(
        "g_hook_find_data",
        constants$148.g_hook_find_data$FUNC, false
    );
    ...
    static final MethodHandle g_hook_find_func$MH = RuntimeHelper.downcallHandle(
        "g_hook_find_func",
        constants$148.g_hook_find_func$FUNC, false
    );
    ...
    static final MethodHandle g_hook_find_func_data$MH = RuntimeHelper.downcallHandle(
        ...
        constants$148.g_hook_find_func_data$FUNC, false
    );
    ...
    static final MethodHandle g_hook_first_valid$MH = RuntimeHelper.downcallHandle(
        "g_hook_first_valid",
        constants$148.g_hook_first_valid$FUNC, false
    );
    ...
    static final MethodHandle g_hook_next_valid$MH = RuntimeHelper.downcallHandle(
        "g_hook_next_valid",
        constants$148.g_hook_next_valid$FUNC, false
    );
    ...
    static final MethodHandle g_hook_compare_ids$MH = RuntimeHelper.downcallHandle(
        "g_hook_compare_ids",
        constants$148.g_hook_compare_ids$FUNC, false
    );
}
