...
public class _GParamSpecValueArray {
    ...
    public static MemoryAddress element_spec$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GParamSpecValueArray.element_spec$VH.get(seg);
    }
    ...
    public static MemoryAddress element_spec$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GParamSpecValueArray.element_spec$VH.get(seg.asSlice(index*sizeof()));
    }
