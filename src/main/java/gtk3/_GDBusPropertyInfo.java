...
public class _GDBusPropertyInfo {
    ...
    public static MemoryAddress name$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusPropertyInfo.name$VH.get(seg);
    }
    ...
    public static MemoryAddress name$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusPropertyInfo.name$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress signature$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusPropertyInfo.signature$VH.get(seg);
    }
    ...
    public static MemoryAddress signature$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusPropertyInfo.signature$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress annotations$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusPropertyInfo.annotations$VH.get(seg);
    }
    ...
    public static MemoryAddress annotations$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusPropertyInfo.annotations$VH.get(seg.asSlice(index*sizeof()));
    }
