...
public class _GStaticRWLock {
    ...
    public static MemoryAddress read_cond$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GStaticRWLock.read_cond$VH.get(seg);
    }
    ...
    public static MemoryAddress read_cond$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GStaticRWLock.read_cond$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress write_cond$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GStaticRWLock.write_cond$VH.get(seg);
    }
    ...
    public static MemoryAddress write_cond$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GStaticRWLock.write_cond$VH.get(seg.asSlice(index*sizeof()));
    }
