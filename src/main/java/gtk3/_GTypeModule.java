...
public class _GTypeModule {
    ...
    public static MemoryAddress type_infos$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypeModule.type_infos$VH.get(seg);
    }
    ...
    public static MemoryAddress type_infos$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypeModule.type_infos$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress interface_infos$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypeModule.interface_infos$VH.get(seg);
    }
    ...
    public static MemoryAddress interface_infos$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypeModule.interface_infos$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress name$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypeModule.name$VH.get(seg);
    }
    ...
    public static MemoryAddress name$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypeModule.name$VH.get(seg.asSlice(index*sizeof()));
    }
