...
public class _GUriParamsIter {
    ...
    public static MemoryAddress dummy1$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GUriParamsIter.dummy1$VH.get(seg);
    }
    ...
    public static MemoryAddress dummy1$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GUriParamsIter.dummy1$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress dummy2$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GUriParamsIter.dummy2$VH.get(seg);
    }
    ...
    public static MemoryAddress dummy2$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GUriParamsIter.dummy2$VH.get(seg.asSlice(index*sizeof()));
    }
