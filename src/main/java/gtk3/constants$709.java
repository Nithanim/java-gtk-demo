...
class constants$709 {
    ...
    static final MethodHandle g_socket_protocol_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$709.g_socket_protocol_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_zlib_compressor_format_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$709.g_zlib_compressor_format_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_unix_socket_address_type_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$709.g_unix_socket_address_type_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_bus_type_get_type$MH = RuntimeHelper.downcallHandle(
        "g_bus_type_get_type",
        constants$709.g_bus_type_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_bus_name_owner_flags_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$709.g_bus_name_owner_flags_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_bus_name_watcher_flags_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$709.g_bus_name_watcher_flags_get_type$FUNC, false
    );
}
