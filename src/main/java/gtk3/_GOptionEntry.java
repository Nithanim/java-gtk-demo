...
public class _GOptionEntry {
    ...
    public static MemoryAddress long_name$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GOptionEntry.long_name$VH.get(seg);
    }
    ...
    public static MemoryAddress long_name$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GOptionEntry.long_name$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress arg_data$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GOptionEntry.arg_data$VH.get(seg);
    }
    ...
    public static MemoryAddress arg_data$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GOptionEntry.arg_data$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress description$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GOptionEntry.description$VH.get(seg);
    }
    ...
    public static MemoryAddress description$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GOptionEntry.description$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress arg_description$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GOptionEntry.arg_description$VH.get(seg);
    }
    ...
    public static MemoryAddress arg_description$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GOptionEntry.arg_description$VH.get(seg.asSlice(index*sizeof()));
    }
