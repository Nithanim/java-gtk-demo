...
class constants$996 {
    ...
    static final MethodHandle hb_font_get_glyph_v_advances_func_t$MH = RuntimeHelper.downcallHandle(
        constants$996.hb_font_get_glyph_v_advances_func_t$FUNC, false
    );
    ...
    static final MethodHandle hb_font_get_glyph_origin_func_t$MH = RuntimeHelper.downcallHandle(
        constants$996.hb_font_get_glyph_origin_func_t$FUNC, false
    );
    ...
    static final MethodHandle hb_font_get_glyph_h_origin_func_t$MH = RuntimeHelper.downcallHandle(
        constants$996.hb_font_get_glyph_h_origin_func_t$FUNC, false
    );
}
