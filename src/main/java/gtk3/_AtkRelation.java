...
public class _AtkRelation {
    ...
    public static MemoryAddress target$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkRelation.target$VH.get(seg);
    }
    ...
    public static MemoryAddress target$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkRelation.target$VH.get(seg.asSlice(index*sizeof()));
    }
