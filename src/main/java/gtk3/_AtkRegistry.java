...
public class _AtkRegistry {
    ...
    public static MemoryAddress factory_type_registry$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkRegistry.factory_type_registry$VH.get(seg);
    }
    ...
    public static MemoryAddress factory_type_registry$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkRegistry.factory_type_registry$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress factory_singleton_cache$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkRegistry.factory_singleton_cache$VH.get(seg);
    }
    ...
    public static MemoryAddress factory_singleton_cache$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkRegistry.factory_singleton_cache$VH.get(seg.asSlice(index*sizeof()));
    }
