...
class constants$107 {
    ...
    static final MethodHandle g_date_set_time$MH = RuntimeHelper.downcallHandle(
        "g_date_set_time",
        constants$107.g_date_set_time$FUNC, false
    );
    ...
    static final MethodHandle g_date_set_month$MH = RuntimeHelper.downcallHandle(
        "g_date_set_month",
        constants$107.g_date_set_month$FUNC, false
    );
    ...
    static final MethodHandle g_date_set_day$MH = RuntimeHelper.downcallHandle(
        "g_date_set_day",
        constants$107.g_date_set_day$FUNC, false
    );
    ...
    static final MethodHandle g_date_set_year$MH = RuntimeHelper.downcallHandle(
        "g_date_set_year",
        constants$107.g_date_set_year$FUNC, false
    );
    ...
    static final MethodHandle g_date_set_dmy$MH = RuntimeHelper.downcallHandle(
        "g_date_set_dmy",
        constants$107.g_date_set_dmy$FUNC, false
    );
    ...
    static final MethodHandle g_date_set_julian$MH = RuntimeHelper.downcallHandle(
        "g_date_set_julian",
        constants$107.g_date_set_julian$FUNC, false
    );
}
