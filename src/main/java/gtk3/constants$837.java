...
class constants$837 {
    ...
    static final MethodHandle g_tcp_wrapper_connection_get_base_io_stream$MH = RuntimeHelper.downcallHandle(
        ...
        constants$837.g_tcp_wrapper_connection_get_base_io_stream$FUNC, false
    );
    ...
    static final MethodHandle g_test_dbus_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$837.g_test_dbus_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_test_dbus_new$MH = RuntimeHelper.downcallHandle(
        "g_test_dbus_new",
        constants$837.g_test_dbus_new$FUNC, false
    );
    ...
    static final MethodHandle g_test_dbus_get_flags$MH = RuntimeHelper.downcallHandle(
        ...
        constants$837.g_test_dbus_get_flags$FUNC, false
    );
    ...
    static final MethodHandle g_test_dbus_get_bus_address$MH = RuntimeHelper.downcallHandle(
        ...
        constants$837.g_test_dbus_get_bus_address$FUNC, false
    );
    ...
    static final MethodHandle g_test_dbus_add_service_dir$MH = RuntimeHelper.downcallHandle(
        ...
        constants$837.g_test_dbus_add_service_dir$FUNC, false
    );
}
