...
public class _GdkWindowAttr {
    ...
    public static MemoryAddress title$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkWindowAttr.title$VH.get(seg);
    }
    ...
    public static MemoryAddress title$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkWindowAttr.title$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress visual$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkWindowAttr.visual$VH.get(seg);
    }
    ...
    public static MemoryAddress visual$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkWindowAttr.visual$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress cursor$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkWindowAttr.cursor$VH.get(seg);
    }
    ...
    public static MemoryAddress cursor$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkWindowAttr.cursor$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress wmclass_name$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkWindowAttr.wmclass_name$VH.get(seg);
    }
    ...
    public static MemoryAddress wmclass_name$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkWindowAttr.wmclass_name$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress wmclass_class$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkWindowAttr.wmclass_class$VH.get(seg);
    }
    ...
    public static MemoryAddress wmclass_class$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkWindowAttr.wmclass_class$VH.get(seg.asSlice(index*sizeof()));
    }
