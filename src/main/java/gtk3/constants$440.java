...
class constants$440 {
    ...
    static final MethodHandle g_closure_ref$MH = RuntimeHelper.downcallHandle(
        "g_closure_ref",
        constants$440.g_closure_ref$FUNC, false
    );
    ...
    static final MethodHandle g_closure_sink$MH = RuntimeHelper.downcallHandle(
        "g_closure_sink",
        constants$440.g_closure_sink$FUNC, false
    );
    ...
    static final MethodHandle g_closure_unref$MH = RuntimeHelper.downcallHandle(
        "g_closure_unref",
        constants$440.g_closure_unref$FUNC, false
    );
    ...
    static final MethodHandle g_closure_new_simple$MH = RuntimeHelper.downcallHandle(
        ...
        constants$440.g_closure_new_simple$FUNC, false
    );
    ...
    static final MethodHandle g_closure_add_finalize_notifier$MH = RuntimeHelper.downcallHandle(
        ...
        constants$440.g_closure_add_finalize_notifier$FUNC, false
    );
    ...
    static final MethodHandle g_closure_remove_finalize_notifier$MH = RuntimeHelper.downcallHandle(
        ...
        constants$440.g_closure_remove_finalize_notifier$FUNC, false
    );
}
