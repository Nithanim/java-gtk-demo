...
class constants$353 {
    ...
    static final MethodHandle pthread_setcancelstate$MH = RuntimeHelper.downcallHandle(
        ...
        constants$353.pthread_setcancelstate$FUNC, false
    );
    ...
    static final MethodHandle pthread_setcanceltype$MH = RuntimeHelper.downcallHandle(
        ...
        constants$353.pthread_setcanceltype$FUNC, false
    );
    ...
    static final MethodHandle pthread_cancel$MH = RuntimeHelper.downcallHandle(
        "pthread_cancel",
        constants$353.pthread_cancel$FUNC, false
    );
    ...
    static final MethodHandle pthread_testcancel$MH = RuntimeHelper.downcallHandle(
        "pthread_testcancel",
        constants$353.pthread_testcancel$FUNC, false
    );
    ...
    static final MethodHandle __pthread_register_cancel$MH = RuntimeHelper.downcallHandle(
        ...
        constants$353.__pthread_register_cancel$FUNC, false
    );
    ...
    static final MethodHandle __pthread_unregister_cancel$MH = RuntimeHelper.downcallHandle(
        ...
        constants$353.__pthread_unregister_cancel$FUNC, false
    );
}
