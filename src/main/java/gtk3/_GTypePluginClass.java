...
public class _GTypePluginClass {
    ...
    public static MemoryAddress use_plugin$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypePluginClass.use_plugin$VH.get(seg);
    }
    ...
    public static MemoryAddress use_plugin$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypePluginClass.use_plugin$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress unuse_plugin$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypePluginClass.unuse_plugin$VH.get(seg);
    }
    ...
    public static MemoryAddress unuse_plugin$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypePluginClass.unuse_plugin$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress complete_type_info$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypePluginClass.complete_type_info$VH.get(seg);
    }
    ...
    public static MemoryAddress complete_type_info$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypePluginClass.complete_type_info$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress complete_interface_info$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypePluginClass.complete_interface_info$VH.get(seg);
    }
    ...
    public static MemoryAddress complete_interface_info$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypePluginClass.complete_interface_info$VH.get(seg.asSlice(index*sizeof()));
    }
