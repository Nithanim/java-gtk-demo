...
public class sigaction {
    ...
    public static class __sigaction_handler {
        ...
        public static MemoryAddress sa_handler$get(MemorySegment seg) {
            return (jdk.incubator.foreign.MemoryAddress)__sigaction_handler.sa_handler$VH.get(seg);
        }
        ...
        public static MemoryAddress sa_handler$get(MemorySegment seg, long index) {
            return (jdk.incubator.foreign.MemoryAddress)__sigaction_handler.sa_handler$VH.get(seg.asSlice(index*sizeof()));
        }
        ...
        public interface sa_sigaction {
            ...
            void apply(int _x0, jdk.incubator.foreign.MemoryAddress _x1, jdk.incubator.foreign.MemoryAddress _x2);
...
return (int _x0, jdk.incubator.foreign.MemoryAddress _x1, jdk.incubator.foreign.MemoryAddress _x2) -> {
                    try {
                        __sigaction_handler.sa_sigaction$MH.invokeExact(symbol, _x0, (jdk.incubator.foreign.Addressable)_x1, (jdk.incubator.foreign.Addressable)_x2);
                    } catch (Throwable ex$) {
        ...
        public static MemoryAddress sa_sigaction$get(MemorySegment seg) {
            return (jdk.incubator.foreign.MemoryAddress)__sigaction_handler.sa_sigaction$VH.get(seg);
        }
        ...
        public static MemoryAddress sa_sigaction$get(MemorySegment seg, long index) {
            return (jdk.incubator.foreign.MemoryAddress)__sigaction_handler.sa_sigaction$VH.get(seg.asSlice(index*sizeof()));
        }
...
return () -> {
    ...
    public static MemoryAddress sa_restorer$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)sigaction.sa_restorer$VH.get(seg);
    }
    ...
    public static MemoryAddress sa_restorer$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)sigaction.sa_restorer$VH.get(seg.asSlice(index*sizeof()));
    }
