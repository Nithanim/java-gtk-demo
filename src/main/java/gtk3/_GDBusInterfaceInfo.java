...
public class _GDBusInterfaceInfo {
    ...
    public static MemoryAddress name$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusInterfaceInfo.name$VH.get(seg);
    }
    ...
    public static MemoryAddress name$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusInterfaceInfo.name$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress methods$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusInterfaceInfo.methods$VH.get(seg);
    }
    ...
    public static MemoryAddress methods$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusInterfaceInfo.methods$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress signals$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusInterfaceInfo.signals$VH.get(seg);
    }
    ...
    public static MemoryAddress signals$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusInterfaceInfo.signals$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress properties$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusInterfaceInfo.properties$VH.get(seg);
    }
    ...
    public static MemoryAddress properties$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusInterfaceInfo.properties$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress annotations$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusInterfaceInfo.annotations$VH.get(seg);
    }
    ...
    public static MemoryAddress annotations$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusInterfaceInfo.annotations$VH.get(seg.asSlice(index*sizeof()));
    }
