...
public class _GdkEventExpose {
    ...
    public static MemoryAddress window$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventExpose.window$VH.get(seg);
    }
    ...
    public static MemoryAddress window$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventExpose.window$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress region$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventExpose.region$VH.get(seg);
    }
    ...
    public static MemoryAddress region$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventExpose.region$VH.get(seg.asSlice(index*sizeof()));
    }
