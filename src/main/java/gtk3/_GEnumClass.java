...
public class _GEnumClass {
    ...
    public static MemoryAddress values$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GEnumClass.values$VH.get(seg);
    }
    ...
    public static MemoryAddress values$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GEnumClass.values$VH.get(seg.asSlice(index*sizeof()));
    }
