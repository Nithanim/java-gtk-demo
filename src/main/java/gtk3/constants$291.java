...
class constants$291 {
    ...
    static final MethodHandle g_slice_free_chain_with_offset$MH = RuntimeHelper.downcallHandle(
        ...
        constants$291.g_slice_free_chain_with_offset$FUNC, false
    );
    ...
    static final MethodHandle g_slice_set_config$MH = RuntimeHelper.downcallHandle(
        "g_slice_set_config",
        constants$291.g_slice_set_config$FUNC, false
    );
    ...
    static final MethodHandle g_slice_get_config$MH = RuntimeHelper.downcallHandle(
        "g_slice_get_config",
        constants$291.g_slice_get_config$FUNC, false
    );
    ...
    static final MethodHandle g_slice_get_config_state$MH = RuntimeHelper.downcallHandle(
        ...
        constants$291.g_slice_get_config_state$FUNC, false
    );
    ...
    static final MethodHandle GSpawnChildSetupFunc$MH = RuntimeHelper.downcallHandle(
        constants$291.GSpawnChildSetupFunc$FUNC, false
    );
}
