...
public class _GtkShortcutsWindowClass {
    ...
    static final MethodHandle close$MH = RuntimeHelper.downcallHandle(
        _GtkShortcutsWindowClass.close$FUNC, false
    );
    public interface close {

        void apply(jdk.incubator.foreign.MemoryAddress _x0);
        static NativeSymbol allocate(close fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(close.class, fi, _GtkShortcutsWindowClass.close$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;)V", scope);
        }
...
return (jdk.incubator.foreign.MemoryAddress _x0) -> {
                try {
                    _GtkShortcutsWindowClass.close$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress close$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkShortcutsWindowClass.close$VH.get(seg);
    }
    ...
    public static MemoryAddress close$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkShortcutsWindowClass.close$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final MethodHandle search$MH = RuntimeHelper.downcallHandle(
        _GtkShortcutsWindowClass.search$FUNC, false
    );
    public interface search {

        void apply(jdk.incubator.foreign.MemoryAddress _x0);
        static NativeSymbol allocate(search fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(search.class, fi, _GtkShortcutsWindowClass.search$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;)V", scope);
        }
        static search ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("search::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return (jdk.incubator.foreign.MemoryAddress _x0) -> {
                try {
                    _GtkShortcutsWindowClass.search$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress search$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkShortcutsWindowClass.search$VH.get(seg);
    }
    ...
    public static MemoryAddress search$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkShortcutsWindowClass.search$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static search search (MemorySegment segment, ResourceScope scope) {
