...
return (jdk.incubator.foreign.MemoryAddress _x0) -> {
                try {
                    return (int)_GPollableInputStreamInterface.can_poll$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress can_poll$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GPollableInputStreamInterface.can_poll$VH.get(seg);
    }
    ...
    public static MemoryAddress can_poll$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GPollableInputStreamInterface.can_poll$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (jdk.incubator.foreign.MemoryAddress _x0) -> {
                try {
                    return (int)_GPollableInputStreamInterface.is_readable$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress is_readable$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GPollableInputStreamInterface.is_readable$VH.get(seg);
    }
    ...
    public static MemoryAddress is_readable$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GPollableInputStreamInterface.is_readable$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1) -> {
                try {
                    return (jdk.incubator.foreign.Addressable)(jdk.incubator.foreign.MemoryAddress)_GPollableInputStreamInterface.create_source$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, (jdk.incubator.foreign.Addressable)_x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress create_source$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GPollableInputStreamInterface.create_source$VH.get(seg);
    }
    ...
    public static MemoryAddress create_source$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GPollableInputStreamInterface.create_source$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1, long _x2, jdk.incubator.foreign.MemoryAddress _x3) -> {
                try {
                    return (long)_GPollableInputStreamInterface.read_nonblocking$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, (jdk.incubator.foreign.Addressable)_x1, _x2, (jdk.incubator.foreign.Addressable)_x3);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress read_nonblocking$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GPollableInputStreamInterface.read_nonblocking$VH.get(seg);
    }
    ...
    public static MemoryAddress read_nonblocking$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GPollableInputStreamInterface.read_nonblocking$VH.get(seg.asSlice(index*sizeof()));
    }
