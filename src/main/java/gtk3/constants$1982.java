...
class constants$1982 {
    ...
    static final MethodHandle gtk_stack_switcher_set_stack$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1982.gtk_stack_switcher_set_stack$FUNC, false
    );
    ...
    static final MethodHandle gtk_stack_switcher_get_stack$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1982.gtk_stack_switcher_get_stack$FUNC, false
    );
    ...
    static final MethodHandle gtk_statusbar_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1982.gtk_statusbar_get_type$FUNC, false
    );
    ...
    static final MethodHandle gtk_statusbar_new$MH = RuntimeHelper.downcallHandle(
        "gtk_statusbar_new",
        constants$1982.gtk_statusbar_new$FUNC, false
    );
    ...
    static final MethodHandle gtk_statusbar_get_context_id$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1982.gtk_statusbar_get_context_id$FUNC, false
    );
    ...
    static final MethodHandle gtk_statusbar_push$MH = RuntimeHelper.downcallHandle(
        "gtk_statusbar_push",
        constants$1982.gtk_statusbar_push$FUNC, false
    );
}
