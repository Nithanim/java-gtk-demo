...
public class _GDatagramBasedInterface {
    ...
    public interface receive_messages {
        ...
        int apply(jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1, int _x2, int _x3, long _x4, jdk.incubator.foreign.MemoryAddress _x5, jdk.incubator.foreign.MemoryAddress _x6);
...
return (jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1, int _x2, int _x3, long _x4, jdk.incubator.foreign.MemoryAddress _x5, jdk.incubator.foreign.MemoryAddress _x6) -> {
                try {
                    return (int)_GDatagramBasedInterface.receive_messages$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, (jdk.incubator.foreign.Addressable)_x1, _x2, _x3, _x4, (jdk.incubator.foreign.Addressable)_x5, (jdk.incubator.foreign.Addressable)_x6);
                } catch (Throwable ex$) {
...
return (jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1, int _x2, int _x3, long _x4, jdk.incubator.foreign.MemoryAddress _x5, jdk.incubator.foreign.MemoryAddress _x6) -> {
                try {
                    return (int)_GDatagramBasedInterface.send_messages$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, (jdk.incubator.foreign.Addressable)_x1, _x2, _x3, _x4, (jdk.incubator.foreign.Addressable)_x5, (jdk.incubator.foreign.Addressable)_x6);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
...
return (jdk.incubator.foreign.MemoryAddress _x0, int _x1, jdk.incubator.foreign.MemoryAddress _x2) -> {
                try {
                    return (jdk.incubator.foreign.Addressable)(jdk.incubator.foreign.MemoryAddress)_GDatagramBasedInterface.create_source$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, _x1, (jdk.incubator.foreign.Addressable)_x2);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
...
return (jdk.incubator.foreign.MemoryAddress _x0, int _x1) -> {
                try {
                    return (int)_GDatagramBasedInterface.condition_check$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, _x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public interface condition_wait {
        ...
        int apply(jdk.incubator.foreign.MemoryAddress _x0, int _x1, long _x2, jdk.incubator.foreign.MemoryAddress _x3, jdk.incubator.foreign.MemoryAddress _x4);
...
return (jdk.incubator.foreign.MemoryAddress _x0, int _x1, long _x2, jdk.incubator.foreign.MemoryAddress _x3, jdk.incubator.foreign.MemoryAddress _x4) -> {
                try {
                    return (int)_GDatagramBasedInterface.condition_wait$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, _x1, _x2, (jdk.incubator.foreign.Addressable)_x3, (jdk.incubator.foreign.Addressable)_x4);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
