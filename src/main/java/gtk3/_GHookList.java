...
public class _GHookList {
    ...
    public static MemoryAddress hooks$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GHookList.hooks$VH.get(seg);
    }
    ...
    public static MemoryAddress hooks$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GHookList.hooks$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress dummy3$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GHookList.dummy3$VH.get(seg);
    }
    ...
    public static MemoryAddress dummy3$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GHookList.dummy3$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress finalize_hook$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GHookList.finalize_hook$VH.get(seg);
    }
    ...
    public static MemoryAddress finalize_hook$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GHookList.finalize_hook$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static GHookFinalizeFunc finalize_hook (MemorySegment segment, ResourceScope scope) {
