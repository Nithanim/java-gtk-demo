...
public class _GtkRcStyle {
    ...
    public static MemoryAddress name$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkRcStyle.name$VH.get(seg);
    }
    ...
    public static MemoryAddress name$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkRcStyle.name$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress font_desc$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkRcStyle.font_desc$VH.get(seg);
    }
    ...
    public static MemoryAddress font_desc$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkRcStyle.font_desc$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress rc_properties$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkRcStyle.rc_properties$VH.get(seg);
    }
    ...
    public static MemoryAddress rc_properties$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkRcStyle.rc_properties$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress rc_style_lists$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkRcStyle.rc_style_lists$VH.get(seg);
    }
    ...
    public static MemoryAddress rc_style_lists$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkRcStyle.rc_style_lists$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress icon_factories$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkRcStyle.icon_factories$VH.get(seg);
    }
    ...
    public static MemoryAddress icon_factories$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkRcStyle.icon_factories$VH.get(seg.asSlice(index*sizeof()));
    }
