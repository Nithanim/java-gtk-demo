...
public class _GtkGLAreaClass {
    ...
    static final MethodHandle render$MH = RuntimeHelper.downcallHandle(
        _GtkGLAreaClass.render$FUNC, false
    );
    public interface render {
        ...
        static NativeSymbol allocate(render fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(render.class, fi, _GtkGLAreaClass.render$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;)I", scope);
        }
...
return (jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1) -> {
                try {
                    return (int)_GtkGLAreaClass.render$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, (jdk.incubator.foreign.Addressable)_x1);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress render$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkGLAreaClass.render$VH.get(seg);
    }
    ...
    public static MemoryAddress render$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkGLAreaClass.render$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final MethodHandle resize$MH = RuntimeHelper.downcallHandle(
        _GtkGLAreaClass.resize$FUNC, false
    );
    public interface resize {

        void apply(jdk.incubator.foreign.MemoryAddress _x0, int _x1, int _x2);
        static NativeSymbol allocate(resize fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(resize.class, fi, _GtkGLAreaClass.resize$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;II)V", scope);
        }
        static resize ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("resize::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return (jdk.incubator.foreign.MemoryAddress _x0, int _x1, int _x2) -> {
                try {
                    _GtkGLAreaClass.resize$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, _x1, _x2);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress resize$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkGLAreaClass.resize$VH.get(seg);
    }
    ...
    public static MemoryAddress resize$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkGLAreaClass.resize$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static resize resize (MemorySegment segment, ResourceScope scope) {
    ...
    static final MethodHandle create_context$MH = RuntimeHelper.downcallHandle(
        _GtkGLAreaClass.create_context$FUNC, false
    );
    public interface create_context {
        ...
        static NativeSymbol allocate(create_context fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(create_context.class, fi, _GtkGLAreaClass.create_context$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;)Ljdk/incubator/foreign/Addressable;", scope);
        }
...
return (jdk.incubator.foreign.MemoryAddress _x0) -> {
                try {
                    return (jdk.incubator.foreign.Addressable)(jdk.incubator.foreign.MemoryAddress)_GtkGLAreaClass.create_context$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress create_context$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkGLAreaClass.create_context$VH.get(seg);
    }
    ...
    public static MemoryAddress create_context$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkGLAreaClass.create_context$VH.get(seg.asSlice(index*sizeof()));
    }
