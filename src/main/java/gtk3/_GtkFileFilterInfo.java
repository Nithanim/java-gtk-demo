...
public class _GtkFileFilterInfo {
    ...
    public static MemoryAddress filename$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkFileFilterInfo.filename$VH.get(seg);
    }
    ...
    public static MemoryAddress filename$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkFileFilterInfo.filename$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress uri$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkFileFilterInfo.uri$VH.get(seg);
    }
    ...
    public static MemoryAddress uri$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkFileFilterInfo.uri$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress display_name$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkFileFilterInfo.display_name$VH.get(seg);
    }
    ...
    public static MemoryAddress display_name$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkFileFilterInfo.display_name$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress mime_type$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkFileFilterInfo.mime_type$VH.get(seg);
    }
    ...
    public static MemoryAddress mime_type$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkFileFilterInfo.mime_type$VH.get(seg.asSlice(index*sizeof()));
    }
