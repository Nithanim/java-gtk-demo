...
public class _PangoGlyphItemIter {
    ...
    public static MemoryAddress glyph_item$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoGlyphItemIter.glyph_item$VH.get(seg);
    }
    ...
    public static MemoryAddress glyph_item$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoGlyphItemIter.glyph_item$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress text$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoGlyphItemIter.text$VH.get(seg);
    }
    ...
    public static MemoryAddress text$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoGlyphItemIter.text$VH.get(seg.asSlice(index*sizeof()));
    }
