...
public class _GTypeInstance {
    ...
    public static MemoryAddress g_class$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypeInstance.g_class$VH.get(seg);
    }
    ...
    public static MemoryAddress g_class$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypeInstance.g_class$VH.get(seg.asSlice(index*sizeof()));
    }
