...
class constants$745 {
    ...
    static final MethodHandle g_mount_get_drive$MH = RuntimeHelper.downcallHandle(
        "g_mount_get_drive",
        constants$745.g_mount_get_drive$FUNC, false
    );
    ...
    static final MethodHandle g_mount_can_unmount$MH = RuntimeHelper.downcallHandle(
        "g_mount_can_unmount",
        constants$745.g_mount_can_unmount$FUNC, false
    );
    ...
    static final MethodHandle g_mount_can_eject$MH = RuntimeHelper.downcallHandle(
        "g_mount_can_eject",
        constants$745.g_mount_can_eject$FUNC, false
    );
    ...
    static final MethodHandle g_mount_unmount$MH = RuntimeHelper.downcallHandle(
        "g_mount_unmount",
        constants$745.g_mount_unmount$FUNC, false
    );
    ...
    static final MethodHandle g_mount_unmount_finish$MH = RuntimeHelper.downcallHandle(
        ...
        constants$745.g_mount_unmount_finish$FUNC, false
    );
    ...
    static final MethodHandle g_mount_eject$MH = RuntimeHelper.downcallHandle(
        "g_mount_eject",
        constants$745.g_mount_eject$FUNC, false
    );
}
