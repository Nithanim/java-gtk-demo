...
public class _GtkToggleActionEntry {
    ...
    public static MemoryAddress name$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkToggleActionEntry.name$VH.get(seg);
    }
    ...
    public static MemoryAddress name$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkToggleActionEntry.name$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress stock_id$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkToggleActionEntry.stock_id$VH.get(seg);
    }
    ...
    public static MemoryAddress stock_id$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkToggleActionEntry.stock_id$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress label$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkToggleActionEntry.label$VH.get(seg);
    }
    ...
    public static MemoryAddress label$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkToggleActionEntry.label$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress accelerator$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkToggleActionEntry.accelerator$VH.get(seg);
    }
    ...
    public static MemoryAddress accelerator$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkToggleActionEntry.accelerator$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress tooltip$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkToggleActionEntry.tooltip$VH.get(seg);
    }
    ...
    public static MemoryAddress tooltip$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkToggleActionEntry.tooltip$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress callback$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkToggleActionEntry.callback$VH.get(seg);
    }
    ...
    public static MemoryAddress callback$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkToggleActionEntry.callback$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static GCallback callback (MemorySegment segment, ResourceScope scope) {
