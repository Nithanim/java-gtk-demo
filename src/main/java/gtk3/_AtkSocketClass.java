...
public class _AtkSocketClass {
    ...
    static final MethodHandle embed$MH = RuntimeHelper.downcallHandle(
        _AtkSocketClass.embed$FUNC, false
    );
    public interface embed {

        void apply(jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1);
        static NativeSymbol allocate(embed fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(embed.class, fi, _AtkSocketClass.embed$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;)V", scope);
        }
        static embed ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("embed::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return (jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1) -> {
                try {
                    _AtkSocketClass.embed$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, (jdk.incubator.foreign.Addressable)_x1);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress embed$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkSocketClass.embed$VH.get(seg);
    }
    ...
    public static MemoryAddress embed$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkSocketClass.embed$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static embed embed (MemorySegment segment, ResourceScope scope) {
