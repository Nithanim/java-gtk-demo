...
public class _GError {
    ...
    public static MemoryAddress message$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GError.message$VH.get(seg);
    }
    ...
    public static MemoryAddress message$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GError.message$VH.get(seg.asSlice(index*sizeof()));
    }
