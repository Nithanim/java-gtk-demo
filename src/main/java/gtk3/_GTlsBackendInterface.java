...
return (jdk.incubator.foreign.MemoryAddress _x0) -> {
                try {
                    return (int)_GTlsBackendInterface.supports_tls$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0);
                } catch (Throwable ex$) {
...
return (jdk.incubator.foreign.MemoryAddress _x0) -> {
                try {
                    return (jdk.incubator.foreign.Addressable)(jdk.incubator.foreign.MemoryAddress)_GTlsBackendInterface.get_default_database$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
...
return (jdk.incubator.foreign.MemoryAddress _x0) -> {
                try {
                    return (int)_GTlsBackendInterface.supports_dtls$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
