...
public class _GDBusSubtreeVTable {
    ...
    public static MemoryAddress enumerate$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusSubtreeVTable.enumerate$VH.get(seg);
    }
    ...
    public static MemoryAddress enumerate$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusSubtreeVTable.enumerate$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static GDBusSubtreeEnumerateFunc enumerate (MemorySegment segment, ResourceScope scope) {
    ...
    public static MemoryAddress introspect$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusSubtreeVTable.introspect$VH.get(seg);
    }
    ...
    public static MemoryAddress introspect$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusSubtreeVTable.introspect$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static GDBusSubtreeIntrospectFunc introspect (MemorySegment segment, ResourceScope scope) {
    ...
    public static MemoryAddress dispatch$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusSubtreeVTable.dispatch$VH.get(seg);
    }
    ...
    public static MemoryAddress dispatch$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusSubtreeVTable.dispatch$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static GDBusSubtreeDispatchFunc dispatch (MemorySegment segment, ResourceScope scope) {
