...
class constants$737 {
    ...
    static final MethodHandle g_menu_link_iter_next$MH = RuntimeHelper.downcallHandle(
        ...
        constants$737.g_menu_link_iter_next$FUNC, false
    );
    ...
    static final MethodHandle g_menu_link_iter_get_name$MH = RuntimeHelper.downcallHandle(
        ...
        constants$737.g_menu_link_iter_get_name$FUNC, false
    );
    ...
    static final MethodHandle g_menu_link_iter_get_value$MH = RuntimeHelper.downcallHandle(
        ...
        constants$737.g_menu_link_iter_get_value$FUNC, false
    );
    ...
    static final MethodHandle g_menu_get_type$MH = RuntimeHelper.downcallHandle(
        "g_menu_get_type",
        constants$737.g_menu_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_menu_new$MH = RuntimeHelper.downcallHandle(
        "g_menu_new",
        constants$737.g_menu_new$FUNC, false
    );
    ...
    static final MethodHandle g_menu_freeze$MH = RuntimeHelper.downcallHandle(
        "g_menu_freeze",
        constants$737.g_menu_freeze$FUNC, false
    );
}
