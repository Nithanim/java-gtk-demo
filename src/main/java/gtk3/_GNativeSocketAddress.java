...
public class _GNativeSocketAddress {
    ...
    public static MemoryAddress priv$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GNativeSocketAddress.priv$VH.get(seg);
    }
    ...
    public static MemoryAddress priv$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GNativeSocketAddress.priv$VH.get(seg.asSlice(index*sizeof()));
    }
