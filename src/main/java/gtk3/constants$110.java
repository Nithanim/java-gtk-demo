...
class constants$110 {
    ...
    static final MethodHandle g_date_days_between$MH = RuntimeHelper.downcallHandle(
        "g_date_days_between",
        constants$110.g_date_days_between$FUNC, false
    );
    ...
    static final MethodHandle g_date_compare$MH = RuntimeHelper.downcallHandle(
        "g_date_compare",
        constants$110.g_date_compare$FUNC, false
    );
    ...
    static final MethodHandle g_date_to_struct_tm$MH = RuntimeHelper.downcallHandle(
        "g_date_to_struct_tm",
        constants$110.g_date_to_struct_tm$FUNC, false
    );
    ...
    static final MethodHandle g_date_clamp$MH = RuntimeHelper.downcallHandle(
        "g_date_clamp",
        constants$110.g_date_clamp$FUNC, false
    );
    ...
    static final MethodHandle g_date_order$MH = RuntimeHelper.downcallHandle(
        "g_date_order",
        constants$110.g_date_order$FUNC, false
    );
    ...
    static final MethodHandle g_date_strftime$MH = RuntimeHelper.downcallHandle(
        "g_date_strftime",
        constants$110.g_date_strftime$FUNC, false
    );
}
