...
return (jdk.incubator.foreign.MemoryAddress _x0) -> {
                try {
                    return (long)_GSeekableIface.tell$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress tell$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GSeekableIface.tell$VH.get(seg);
    }
    ...
    public static MemoryAddress tell$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GSeekableIface.tell$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (jdk.incubator.foreign.MemoryAddress _x0) -> {
                try {
                    return (int)_GSeekableIface.can_seek$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress can_seek$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GSeekableIface.can_seek$VH.get(seg);
    }
    ...
    public static MemoryAddress can_seek$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GSeekableIface.can_seek$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (jdk.incubator.foreign.MemoryAddress _x0, long _x1, int _x2, jdk.incubator.foreign.MemoryAddress _x3, jdk.incubator.foreign.MemoryAddress _x4) -> {
                try {
                    return (int)_GSeekableIface.seek$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, _x1, _x2, (jdk.incubator.foreign.Addressable)_x3, (jdk.incubator.foreign.Addressable)_x4);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress seek$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GSeekableIface.seek$VH.get(seg);
    }
    ...
    public static MemoryAddress seek$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GSeekableIface.seek$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (jdk.incubator.foreign.MemoryAddress _x0) -> {
                try {
                    return (int)_GSeekableIface.can_truncate$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress can_truncate$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GSeekableIface.can_truncate$VH.get(seg);
    }
    ...
    public static MemoryAddress can_truncate$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GSeekableIface.can_truncate$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (jdk.incubator.foreign.MemoryAddress _x0, long _x1, jdk.incubator.foreign.MemoryAddress _x2, jdk.incubator.foreign.MemoryAddress _x3) -> {
                try {
                    return (int)_GSeekableIface.truncate_fn$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, _x1, (jdk.incubator.foreign.Addressable)_x2, (jdk.incubator.foreign.Addressable)_x3);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress truncate_fn$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GSeekableIface.truncate_fn$VH.get(seg);
    }
    ...
    public static MemoryAddress truncate_fn$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GSeekableIface.truncate_fn$VH.get(seg.asSlice(index*sizeof()));
    }
