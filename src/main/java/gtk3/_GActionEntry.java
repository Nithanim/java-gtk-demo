...
public class _GActionEntry {
    ...
    public static MemoryAddress name$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GActionEntry.name$VH.get(seg);
    }
    ...
    public static MemoryAddress name$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GActionEntry.name$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1, jdk.incubator.foreign.MemoryAddress _x2) -> {
                try {
                    _GActionEntry.activate$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, (jdk.incubator.foreign.Addressable)_x1, (jdk.incubator.foreign.Addressable)_x2);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress activate$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GActionEntry.activate$VH.get(seg);
    }
    ...
    public static MemoryAddress activate$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GActionEntry.activate$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress parameter_type$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GActionEntry.parameter_type$VH.get(seg);
    }
    ...
    public static MemoryAddress parameter_type$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GActionEntry.parameter_type$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress state$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GActionEntry.state$VH.get(seg);
    }
    ...
    public static MemoryAddress state$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GActionEntry.state$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1, jdk.incubator.foreign.MemoryAddress _x2) -> {
                try {
                    _GActionEntry.change_state$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, (jdk.incubator.foreign.Addressable)_x1, (jdk.incubator.foreign.Addressable)_x2);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress change_state$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GActionEntry.change_state$VH.get(seg);
    }
    ...
    public static MemoryAddress change_state$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GActionEntry.change_state$VH.get(seg.asSlice(index*sizeof()));
    }
