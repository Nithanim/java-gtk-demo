...
public class _GtkTextMark {
    ...
    public static MemoryAddress segment$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkTextMark.segment$VH.get(seg);
    }
    ...
    public static MemoryAddress segment$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkTextMark.segment$VH.get(seg.asSlice(index*sizeof()));
    }
