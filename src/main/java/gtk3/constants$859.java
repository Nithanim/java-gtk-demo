...
class constants$859 {
    ...
    static final MethodHandle g_volume_can_eject$MH = RuntimeHelper.downcallHandle(
        "g_volume_can_eject",
        constants$859.g_volume_can_eject$FUNC, false
    );
    ...
    static final MethodHandle g_volume_should_automount$MH = RuntimeHelper.downcallHandle(
        ...
        constants$859.g_volume_should_automount$FUNC, false
    );
    ...
    static final MethodHandle g_volume_mount$MH = RuntimeHelper.downcallHandle(
        "g_volume_mount",
        constants$859.g_volume_mount$FUNC, false
    );
    ...
    static final MethodHandle g_volume_mount_finish$MH = RuntimeHelper.downcallHandle(
        ...
        constants$859.g_volume_mount_finish$FUNC, false
    );
    ...
    static final MethodHandle g_volume_eject$MH = RuntimeHelper.downcallHandle(
        "g_volume_eject",
        constants$859.g_volume_eject$FUNC, false
    );
    ...
    static final MethodHandle g_volume_eject_finish$MH = RuntimeHelper.downcallHandle(
        ...
        constants$859.g_volume_eject_finish$FUNC, false
    );
}
