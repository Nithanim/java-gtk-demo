...
class constants$750 {
    ...
    static final MethodHandle g_mount_operation_get_password_save$MH = RuntimeHelper.downcallHandle(
        ...
        constants$750.g_mount_operation_get_password_save$FUNC, false
    );
    ...
    static final MethodHandle g_mount_operation_set_password_save$MH = RuntimeHelper.downcallHandle(
        ...
        constants$750.g_mount_operation_set_password_save$FUNC, false
    );
    ...
    static final MethodHandle g_mount_operation_get_choice$MH = RuntimeHelper.downcallHandle(
        ...
        constants$750.g_mount_operation_get_choice$FUNC, false
    );
    ...
    static final MethodHandle g_mount_operation_set_choice$MH = RuntimeHelper.downcallHandle(
        ...
        constants$750.g_mount_operation_set_choice$FUNC, false
    );
    ...
    static final MethodHandle g_mount_operation_reply$MH = RuntimeHelper.downcallHandle(
        ...
        constants$750.g_mount_operation_reply$FUNC, false
    );
    ...
    static final MethodHandle g_mount_operation_get_is_tcrypt_hidden_volume$MH = RuntimeHelper.downcallHandle(
        ...
        constants$750.g_mount_operation_get_is_tcrypt_hidden_volume$FUNC, false
    );
}
