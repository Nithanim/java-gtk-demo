...
class constants$303 {
    ...
    static final MethodHandle g_strv_contains$MH = RuntimeHelper.downcallHandle(
        "g_strv_contains",
        constants$303.g_strv_contains$FUNC, false
    );
    ...
    static final MethodHandle g_strv_equal$MH = RuntimeHelper.downcallHandle(
        "g_strv_equal",
        constants$303.g_strv_equal$FUNC, false
    );
    ...
    static final MethodHandle g_number_parser_error_quark$MH = RuntimeHelper.downcallHandle(
        ...
        constants$303.g_number_parser_error_quark$FUNC, false
    );
    ...
    static final MethodHandle g_ascii_string_to_signed$MH = RuntimeHelper.downcallHandle(
        ...
        constants$303.g_ascii_string_to_signed$FUNC, false
    );
    ...
    static final MethodHandle g_ascii_string_to_unsigned$MH = RuntimeHelper.downcallHandle(
        ...
        constants$303.g_ascii_string_to_unsigned$FUNC, false
    );
    ...
    static final MethodHandle g_string_chunk_new$MH = RuntimeHelper.downcallHandle(
        "g_string_chunk_new",
        constants$303.g_string_chunk_new$FUNC, false
    );
}
