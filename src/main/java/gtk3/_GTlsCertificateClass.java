...
return (jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1, jdk.incubator.foreign.MemoryAddress _x2) -> {
                try {
                    return (int)_GTlsCertificateClass.verify$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, (jdk.incubator.foreign.Addressable)_x1, (jdk.incubator.foreign.Addressable)_x2);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress verify$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GTlsCertificateClass.verify$VH.get(seg);
    }
    ...
    public static MemoryAddress verify$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GTlsCertificateClass.verify$VH.get(seg.asSlice(index*sizeof()));
    }
