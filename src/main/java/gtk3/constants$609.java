...
class constants$609 {
    ...
    static final MethodHandle g_dbus_message_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$609.g_dbus_message_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_dbus_message_new$MH = RuntimeHelper.downcallHandle(
        "g_dbus_message_new",
        constants$609.g_dbus_message_new$FUNC, false
    );
    ...
    static final MethodHandle g_dbus_message_new_signal$MH = RuntimeHelper.downcallHandle(
        ...
        constants$609.g_dbus_message_new_signal$FUNC, false
    );
    ...
    static final MethodHandle g_dbus_message_new_method_call$MH = RuntimeHelper.downcallHandle(
        ...
        constants$609.g_dbus_message_new_method_call$FUNC, false
    );
    ...
    static final MethodHandle g_dbus_message_new_method_reply$MH = RuntimeHelper.downcallHandle(
        ...
        constants$609.g_dbus_message_new_method_reply$FUNC, false
    );
    ...
    static final MethodHandle g_dbus_message_new_method_error$MH = RuntimeHelper.downcallHandle(
        ...
        constants$609.g_dbus_message_new_method_error$FUNC, true
    );
}
