...
class constants$808 {
    ...
    static final MethodHandle g_socket_send_message_with_timeout$MH = RuntimeHelper.downcallHandle(
        ...
        constants$808.g_socket_send_message_with_timeout$FUNC, false
    );
    ...
    static final MethodHandle g_socket_get_option$MH = RuntimeHelper.downcallHandle(
        "g_socket_get_option",
        constants$808.g_socket_get_option$FUNC, false
    );
    ...
    static final MethodHandle g_socket_set_option$MH = RuntimeHelper.downcallHandle(
        "g_socket_set_option",
        constants$808.g_socket_set_option$FUNC, false
    );
    ...
    static final MethodHandle g_socket_client_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$808.g_socket_client_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_socket_client_new$MH = RuntimeHelper.downcallHandle(
        "g_socket_client_new",
        constants$808.g_socket_client_new$FUNC, false
    );
    ...
    static final MethodHandle g_socket_client_get_family$MH = RuntimeHelper.downcallHandle(
        ...
        constants$808.g_socket_client_get_family$FUNC, false
    );
}
