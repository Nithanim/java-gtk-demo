...
public class _GtkPopoverClass {
    ...
    static final MethodHandle closed$MH = RuntimeHelper.downcallHandle(
        _GtkPopoverClass.closed$FUNC, false
    );
    public interface closed {

        void apply(jdk.incubator.foreign.MemoryAddress _x0);
        static NativeSymbol allocate(closed fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(closed.class, fi, _GtkPopoverClass.closed$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;)V", scope);
        }
...
return (jdk.incubator.foreign.MemoryAddress _x0) -> {
                try {
                    _GtkPopoverClass.closed$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress closed$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkPopoverClass.closed$VH.get(seg);
    }
    ...
    public static MemoryAddress closed$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkPopoverClass.closed$VH.get(seg.asSlice(index*sizeof()));
    }
