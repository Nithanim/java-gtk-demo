...
public class _GtkSwitchClass {
    ...
    static final MethodHandle activate$MH = RuntimeHelper.downcallHandle(
        _GtkSwitchClass.activate$FUNC, false
    );
    public interface activate {

        void apply(jdk.incubator.foreign.MemoryAddress _x0);
        static NativeSymbol allocate(activate fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(activate.class, fi, _GtkSwitchClass.activate$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;)V", scope);
        }
...
return (jdk.incubator.foreign.MemoryAddress _x0) -> {
                try {
                    _GtkSwitchClass.activate$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress activate$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkSwitchClass.activate$VH.get(seg);
    }
    ...
    public static MemoryAddress activate$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkSwitchClass.activate$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final MethodHandle state_set$MH = RuntimeHelper.downcallHandle(
        _GtkSwitchClass.state_set$FUNC, false
    );
    public interface state_set {

        int apply(jdk.incubator.foreign.MemoryAddress _x0, int _x1);
        static NativeSymbol allocate(state_set fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(state_set.class, fi, _GtkSwitchClass.state_set$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;I)I", scope);
        }
        static state_set ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("state_set::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return (jdk.incubator.foreign.MemoryAddress _x0, int _x1) -> {
                try {
                    return (int)_GtkSwitchClass.state_set$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, _x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress state_set$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkSwitchClass.state_set$VH.get(seg);
    }
    ...
    public static MemoryAddress state_set$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkSwitchClass.state_set$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static state_set state_set (MemorySegment segment, ResourceScope scope) {
    ...
    static final MethodHandle _switch_padding_1$MH = RuntimeHelper.downcallHandle(
        _GtkSwitchClass._switch_padding_1$FUNC, false
    );
    public interface _switch_padding_1 {

        void apply();
        static NativeSymbol allocate(_switch_padding_1 fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(_switch_padding_1.class, fi, _GtkSwitchClass._switch_padding_1$FUNC, "()V", scope);
        }
        static _switch_padding_1 ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("_switch_padding_1::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return () -> {
                try {
                    _GtkSwitchClass._switch_padding_1$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress _switch_padding_1$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkSwitchClass._switch_padding_1$VH.get(seg);
    }
    ...
    public static MemoryAddress _switch_padding_1$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkSwitchClass._switch_padding_1$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static _switch_padding_1 _switch_padding_1 (MemorySegment segment, ResourceScope scope) {
    ...
    static final MethodHandle _switch_padding_2$MH = RuntimeHelper.downcallHandle(
        _GtkSwitchClass._switch_padding_2$FUNC, false
    );
    public interface _switch_padding_2 {

        void apply();
        static NativeSymbol allocate(_switch_padding_2 fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(_switch_padding_2.class, fi, _GtkSwitchClass._switch_padding_2$FUNC, "()V", scope);
        }
        static _switch_padding_2 ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("_switch_padding_2::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return () -> {
                try {
                    _GtkSwitchClass._switch_padding_2$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress _switch_padding_2$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkSwitchClass._switch_padding_2$VH.get(seg);
    }
    ...
    public static MemoryAddress _switch_padding_2$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkSwitchClass._switch_padding_2$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static _switch_padding_2 _switch_padding_2 (MemorySegment segment, ResourceScope scope) {
    ...
    static final MethodHandle _switch_padding_3$MH = RuntimeHelper.downcallHandle(
        _GtkSwitchClass._switch_padding_3$FUNC, false
    );
    public interface _switch_padding_3 {

        void apply();
        static NativeSymbol allocate(_switch_padding_3 fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(_switch_padding_3.class, fi, _GtkSwitchClass._switch_padding_3$FUNC, "()V", scope);
        }
        static _switch_padding_3 ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("_switch_padding_3::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return () -> {
                try {
                    _GtkSwitchClass._switch_padding_3$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress _switch_padding_3$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkSwitchClass._switch_padding_3$VH.get(seg);
    }
    ...
    public static MemoryAddress _switch_padding_3$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkSwitchClass._switch_padding_3$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static _switch_padding_3 _switch_padding_3 (MemorySegment segment, ResourceScope scope) {
    ...
    static final MethodHandle _switch_padding_4$MH = RuntimeHelper.downcallHandle(
        _GtkSwitchClass._switch_padding_4$FUNC, false
    );
    public interface _switch_padding_4 {

        void apply();
        static NativeSymbol allocate(_switch_padding_4 fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(_switch_padding_4.class, fi, _GtkSwitchClass._switch_padding_4$FUNC, "()V", scope);
        }
        static _switch_padding_4 ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("_switch_padding_4::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return () -> {
                try {
                    _GtkSwitchClass._switch_padding_4$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress _switch_padding_4$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkSwitchClass._switch_padding_4$VH.get(seg);
    }
    ...
    public static MemoryAddress _switch_padding_4$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkSwitchClass._switch_padding_4$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static _switch_padding_4 _switch_padding_4 (MemorySegment segment, ResourceScope scope) {
    ...
    static final MethodHandle _switch_padding_5$MH = RuntimeHelper.downcallHandle(
        _GtkSwitchClass._switch_padding_5$FUNC, false
    );
    public interface _switch_padding_5 {

        void apply();
        static NativeSymbol allocate(_switch_padding_5 fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(_switch_padding_5.class, fi, _GtkSwitchClass._switch_padding_5$FUNC, "()V", scope);
        }
        static _switch_padding_5 ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("_switch_padding_5::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return () -> {
                try {
                    _GtkSwitchClass._switch_padding_5$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress _switch_padding_5$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkSwitchClass._switch_padding_5$VH.get(seg);
    }
    ...
    public static MemoryAddress _switch_padding_5$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkSwitchClass._switch_padding_5$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static _switch_padding_5 _switch_padding_5 (MemorySegment segment, ResourceScope scope) {
