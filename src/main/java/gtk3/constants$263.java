...
class constants$263 {
    ...
    static final MethodHandle g_ref_string_acquire$MH = RuntimeHelper.downcallHandle(
        ...
        constants$263.g_ref_string_acquire$FUNC, false
    );
    ...
    static final MethodHandle g_ref_string_release$MH = RuntimeHelper.downcallHandle(
        ...
        constants$263.g_ref_string_release$FUNC, false
    );
    ...
    static final MethodHandle g_ref_string_length$MH = RuntimeHelper.downcallHandle(
        "g_ref_string_length",
        constants$263.g_ref_string_length$FUNC, false
    );
    ...
    static final MethodHandle g_regex_error_quark$MH = RuntimeHelper.downcallHandle(
        "g_regex_error_quark",
        constants$263.g_regex_error_quark$FUNC, false
    );
    ...
    static final MethodHandle GRegexEvalCallback$MH = RuntimeHelper.downcallHandle(
        constants$263.GRegexEvalCallback$FUNC, false
    );
}
