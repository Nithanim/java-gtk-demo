...
public class _GFlagsClass {
    ...
    public static MemoryAddress values$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GFlagsClass.values$VH.get(seg);
    }
    ...
    public static MemoryAddress values$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GFlagsClass.values$VH.get(seg.asSlice(index*sizeof()));
    }
