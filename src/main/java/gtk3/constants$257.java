...
class constants$257 {
    ...
    static final MethodHandle g_rand_set_seed$MH = RuntimeHelper.downcallHandle(
        "g_rand_set_seed",
        constants$257.g_rand_set_seed$FUNC, false
    );
    ...
    static final MethodHandle g_rand_set_seed_array$MH = RuntimeHelper.downcallHandle(
        ...
        constants$257.g_rand_set_seed_array$FUNC, false
    );
    ...
    static final MethodHandle g_rand_int$MH = RuntimeHelper.downcallHandle(
        "g_rand_int",
        constants$257.g_rand_int$FUNC, false
    );
    ...
    static final MethodHandle g_rand_int_range$MH = RuntimeHelper.downcallHandle(
        "g_rand_int_range",
        constants$257.g_rand_int_range$FUNC, false
    );
    ...
    static final MethodHandle g_rand_double$MH = RuntimeHelper.downcallHandle(
        "g_rand_double",
        constants$257.g_rand_double$FUNC, false
    );
    ...
    static final MethodHandle g_rand_double_range$MH = RuntimeHelper.downcallHandle(
        "g_rand_double_range",
        constants$257.g_rand_double_range$FUNC, false
    );
}
