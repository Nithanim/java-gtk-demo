...
public class _GTypeQuery {
    ...
    public static MemoryAddress type_name$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypeQuery.type_name$VH.get(seg);
    }
    ...
    public static MemoryAddress type_name$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypeQuery.type_name$VH.get(seg.asSlice(index*sizeof()));
    }
