...
class constants$352 {
    ...
    static final MethodHandle pthread_setschedparam$MH = RuntimeHelper.downcallHandle(
        ...
        constants$352.pthread_setschedparam$FUNC, false
    );
    ...
    static final MethodHandle pthread_getschedparam$MH = RuntimeHelper.downcallHandle(
        ...
        constants$352.pthread_getschedparam$FUNC, false
    );
    ...
    static final MethodHandle pthread_setschedprio$MH = RuntimeHelper.downcallHandle(
        ...
        constants$352.pthread_setschedprio$FUNC, false
    );
    ...
    static final MethodHandle pthread_once$__init_routine$MH = RuntimeHelper.downcallHandle(
        constants$352.pthread_once$__init_routine$FUNC, false
    );
    ...
    static final MethodHandle pthread_once$MH = RuntimeHelper.downcallHandle(
        "pthread_once",
        constants$352.pthread_once$FUNC, false
    );
}
