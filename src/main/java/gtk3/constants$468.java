...
class constants$468 {
    ...
    static final MethodHandle g_object_interface_install_property$MH = RuntimeHelper.downcallHandle(
        ...
        constants$468.g_object_interface_install_property$FUNC, false
    );
    ...
    static final MethodHandle g_object_interface_find_property$MH = RuntimeHelper.downcallHandle(
        ...
        constants$468.g_object_interface_find_property$FUNC, false
    );
    ...
    static final MethodHandle g_object_interface_list_properties$MH = RuntimeHelper.downcallHandle(
        ...
        constants$468.g_object_interface_list_properties$FUNC, false
    );
    ...
    static final MethodHandle g_object_get_type$MH = RuntimeHelper.downcallHandle(
        "g_object_get_type",
        constants$468.g_object_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_object_new$MH = RuntimeHelper.downcallHandle(
        "g_object_new",
        constants$468.g_object_new$FUNC, true
    );
    ...
    static final MethodHandle g_object_new_with_properties$MH = RuntimeHelper.downcallHandle(
        ...
        constants$468.g_object_new_with_properties$FUNC, false
    );
}
