...
public class _GDBusAnnotationInfo {
    ...
    public static MemoryAddress key$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusAnnotationInfo.key$VH.get(seg);
    }
    ...
    public static MemoryAddress key$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusAnnotationInfo.key$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress value$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusAnnotationInfo.value$VH.get(seg);
    }
    ...
    public static MemoryAddress value$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusAnnotationInfo.value$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress annotations$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusAnnotationInfo.annotations$VH.get(seg);
    }
    ...
    public static MemoryAddress annotations$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusAnnotationInfo.annotations$VH.get(seg.asSlice(index*sizeof()));
    }
