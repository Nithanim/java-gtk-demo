...
public class _GConverterIface {
    ...
    public interface convert {
        ...
        int apply(jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1, long _x2, jdk.incubator.foreign.MemoryAddress _x3, long _x4, int _x5, jdk.incubator.foreign.MemoryAddress _x6, jdk.incubator.foreign.MemoryAddress _x7, jdk.incubator.foreign.MemoryAddress _x8);
...
return (jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1, long _x2, jdk.incubator.foreign.MemoryAddress _x3, long _x4, int _x5, jdk.incubator.foreign.MemoryAddress _x6, jdk.incubator.foreign.MemoryAddress _x7, jdk.incubator.foreign.MemoryAddress _x8) -> {
                try {
                    return (int)_GConverterIface.convert$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, (jdk.incubator.foreign.Addressable)_x1, _x2, (jdk.incubator.foreign.Addressable)_x3, _x4, _x5, (jdk.incubator.foreign.Addressable)_x6, (jdk.incubator.foreign.Addressable)_x7, (jdk.incubator.foreign.Addressable)_x8);
                } catch (Throwable ex$) {
...
return (jdk.incubator.foreign.MemoryAddress _x0) -> {
                try {
                    _GConverterIface.reset$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
