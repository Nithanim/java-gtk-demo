...
public class _GTypeModuleClass {
    ...
    static final MethodHandle load$MH = RuntimeHelper.downcallHandle(
        _GTypeModuleClass.load$FUNC, false
    );
    public interface load {

        int apply(jdk.incubator.foreign.MemoryAddress _x0);
        static NativeSymbol allocate(load fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(load.class, fi, _GTypeModuleClass.load$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;)I", scope);
        }
...
return (jdk.incubator.foreign.MemoryAddress _x0) -> {
                try {
                    return (int)_GTypeModuleClass.load$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress load$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypeModuleClass.load$VH.get(seg);
    }
    ...
    public static MemoryAddress load$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypeModuleClass.load$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final MethodHandle unload$MH = RuntimeHelper.downcallHandle(
        _GTypeModuleClass.unload$FUNC, false
    );
    public interface unload {

        void apply(jdk.incubator.foreign.MemoryAddress _x0);
        static NativeSymbol allocate(unload fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(unload.class, fi, _GTypeModuleClass.unload$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;)V", scope);
        }
        static unload ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("unload::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return (jdk.incubator.foreign.MemoryAddress _x0) -> {
                try {
                    _GTypeModuleClass.unload$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress unload$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypeModuleClass.unload$VH.get(seg);
    }
    ...
    public static MemoryAddress unload$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypeModuleClass.unload$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static unload unload (MemorySegment segment, ResourceScope scope) {
    ...
    static final MethodHandle reserved1$MH = RuntimeHelper.downcallHandle(
        _GTypeModuleClass.reserved1$FUNC, false
    );
    public interface reserved1 {

        void apply();
        static NativeSymbol allocate(reserved1 fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(reserved1.class, fi, _GTypeModuleClass.reserved1$FUNC, "()V", scope);
        }
...
return () -> {
                try {
                    _GTypeModuleClass.reserved1$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress reserved1$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypeModuleClass.reserved1$VH.get(seg);
    }
    ...
    public static MemoryAddress reserved1$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypeModuleClass.reserved1$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final MethodHandle reserved2$MH = RuntimeHelper.downcallHandle(
        _GTypeModuleClass.reserved2$FUNC, false
    );
    public interface reserved2 {

        void apply();
        static NativeSymbol allocate(reserved2 fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(reserved2.class, fi, _GTypeModuleClass.reserved2$FUNC, "()V", scope);
        }
...
return () -> {
                try {
                    _GTypeModuleClass.reserved2$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress reserved2$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypeModuleClass.reserved2$VH.get(seg);
    }
    ...
    public static MemoryAddress reserved2$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypeModuleClass.reserved2$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final MethodHandle reserved3$MH = RuntimeHelper.downcallHandle(
        _GTypeModuleClass.reserved3$FUNC, false
    );
    public interface reserved3 {

        void apply();
        static NativeSymbol allocate(reserved3 fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(reserved3.class, fi, _GTypeModuleClass.reserved3$FUNC, "()V", scope);
        }
...
return () -> {
                try {
                    _GTypeModuleClass.reserved3$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress reserved3$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypeModuleClass.reserved3$VH.get(seg);
    }
    ...
    public static MemoryAddress reserved3$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypeModuleClass.reserved3$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final MethodHandle reserved4$MH = RuntimeHelper.downcallHandle(
        _GTypeModuleClass.reserved4$FUNC, false
    );
    public interface reserved4 {

        void apply();
        static NativeSymbol allocate(reserved4 fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(reserved4.class, fi, _GTypeModuleClass.reserved4$FUNC, "()V", scope);
        }
...
return () -> {
                try {
                    _GTypeModuleClass.reserved4$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress reserved4$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypeModuleClass.reserved4$VH.get(seg);
    }
    ...
    public static MemoryAddress reserved4$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GTypeModuleClass.reserved4$VH.get(seg.asSlice(index*sizeof()));
    }
