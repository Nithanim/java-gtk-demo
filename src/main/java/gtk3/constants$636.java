...
class constants$636 {
    ...
    static final MethodHandle g_dbus_generate_guid$MH = RuntimeHelper.downcallHandle(
        ...
        constants$636.g_dbus_generate_guid$FUNC, false
    );
    ...
    static final MethodHandle g_dbus_is_name$MH = RuntimeHelper.downcallHandle(
        "g_dbus_is_name",
        constants$636.g_dbus_is_name$FUNC, false
    );
    ...
    static final MethodHandle g_dbus_is_unique_name$MH = RuntimeHelper.downcallHandle(
        ...
        constants$636.g_dbus_is_unique_name$FUNC, false
    );
    ...
    static final MethodHandle g_dbus_is_member_name$MH = RuntimeHelper.downcallHandle(
        ...
        constants$636.g_dbus_is_member_name$FUNC, false
    );
    ...
    static final MethodHandle g_dbus_is_interface_name$MH = RuntimeHelper.downcallHandle(
        ...
        constants$636.g_dbus_is_interface_name$FUNC, false
    );
    ...
    static final MethodHandle g_dbus_gvariant_to_gvalue$MH = RuntimeHelper.downcallHandle(
        ...
        constants$636.g_dbus_gvariant_to_gvalue$FUNC, false
    );
}
