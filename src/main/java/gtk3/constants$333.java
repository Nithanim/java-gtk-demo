...
class constants$333 {
    ...
    static final MethodHandle g_uri_parse_scheme$MH = RuntimeHelper.downcallHandle(
        "g_uri_parse_scheme",
        constants$333.g_uri_parse_scheme$FUNC, false
    );
    ...
    static final MethodHandle g_uri_peek_scheme$MH = RuntimeHelper.downcallHandle(
        "g_uri_peek_scheme",
        constants$333.g_uri_peek_scheme$FUNC, false
    );
    ...
    static final MethodHandle g_uri_escape_string$MH = RuntimeHelper.downcallHandle(
        "g_uri_escape_string",
        constants$333.g_uri_escape_string$FUNC, false
    );
    ...
    static final MethodHandle g_uri_unescape_bytes$MH = RuntimeHelper.downcallHandle(
        ...
        constants$333.g_uri_unescape_bytes$FUNC, false
    );
    ...
    static final MethodHandle g_uri_escape_bytes$MH = RuntimeHelper.downcallHandle(
        "g_uri_escape_bytes",
        constants$333.g_uri_escape_bytes$FUNC, false
    );
    ...
    static final MethodHandle g_uuid_string_is_valid$MH = RuntimeHelper.downcallHandle(
        ...
        constants$333.g_uuid_string_is_valid$FUNC, false
    );
}
