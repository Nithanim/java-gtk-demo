...
public class _GtkAppChooserWidgetClass {
    ...
    static final MethodHandle application_selected$MH = RuntimeHelper.downcallHandle(
        _GtkAppChooserWidgetClass.application_selected$FUNC, false
    );
    public interface application_selected {
        ...
        static NativeSymbol allocate(application_selected fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(application_selected.class, fi, _GtkAppChooserWidgetClass.application_selected$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;)V", scope);
        }
        static application_selected ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("application_selected::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return (jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1) -> {
                try {
                    _GtkAppChooserWidgetClass.application_selected$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, (jdk.incubator.foreign.Addressable)_x1);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress application_selected$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkAppChooserWidgetClass.application_selected$VH.get(seg);
    }
    ...
    public static MemoryAddress application_selected$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkAppChooserWidgetClass.application_selected$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static application_selected application_selected (MemorySegment segment, ResourceScope scope) {
    ...
    static final MethodHandle application_activated$MH = RuntimeHelper.downcallHandle(
        _GtkAppChooserWidgetClass.application_activated$FUNC, false
    );
    public interface application_activated {

        void apply(jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1);
        static NativeSymbol allocate(application_activated fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(application_activated.class, fi, _GtkAppChooserWidgetClass.application_activated$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;)V", scope);
        }
        static application_activated ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("application_activated::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return (jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1) -> {
                try {
                    _GtkAppChooserWidgetClass.application_activated$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, (jdk.incubator.foreign.Addressable)_x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress application_activated$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkAppChooserWidgetClass.application_activated$VH.get(seg);
    }
    ...
    public static MemoryAddress application_activated$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkAppChooserWidgetClass.application_activated$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static application_activated application_activated (MemorySegment segment, ResourceScope scope) {
    ...
    static final MethodHandle populate_popup$MH = RuntimeHelper.downcallHandle(
        _GtkAppChooserWidgetClass.populate_popup$FUNC, false
    );
    public interface populate_popup {
        ...
        static NativeSymbol allocate(populate_popup fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(populate_popup.class, fi, _GtkAppChooserWidgetClass.populate_popup$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;)V", scope);
        }
...
return (jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1, jdk.incubator.foreign.MemoryAddress _x2) -> {
                try {
                    _GtkAppChooserWidgetClass.populate_popup$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, (jdk.incubator.foreign.Addressable)_x1, (jdk.incubator.foreign.Addressable)_x2);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress populate_popup$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkAppChooserWidgetClass.populate_popup$VH.get(seg);
    }
    ...
    public static MemoryAddress populate_popup$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkAppChooserWidgetClass.populate_popup$VH.get(seg.asSlice(index*sizeof()));
    }
