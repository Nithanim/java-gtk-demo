...
public class _GMemVTable {
    ...
    public interface malloc {
        ...
        jdk.incubator.foreign.Addressable apply(long _x0);
...
return (long _x0) -> {
                try {
                    return (jdk.incubator.foreign.Addressable)(jdk.incubator.foreign.MemoryAddress)_GMemVTable.malloc$MH.invokeExact(symbol, _x0);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress malloc$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GMemVTable.malloc$VH.get(seg);
    }
    ...
    public static MemoryAddress malloc$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GMemVTable.malloc$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public interface realloc {
        ...
        jdk.incubator.foreign.Addressable apply(jdk.incubator.foreign.MemoryAddress _x0, long _x1);
...
return (jdk.incubator.foreign.MemoryAddress _x0, long _x1) -> {
                try {
                    return (jdk.incubator.foreign.Addressable)(jdk.incubator.foreign.MemoryAddress)_GMemVTable.realloc$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, _x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress realloc$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GMemVTable.realloc$VH.get(seg);
    }
    ...
    public static MemoryAddress realloc$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GMemVTable.realloc$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (jdk.incubator.foreign.MemoryAddress _x0) -> {
                try {
                    _GMemVTable.free$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress free$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GMemVTable.free$VH.get(seg);
    }
    ...
    public static MemoryAddress free$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GMemVTable.free$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public interface calloc {
        ...
        jdk.incubator.foreign.Addressable apply(long _x0, long _x1);
...
return (long _x0, long _x1) -> {
                try {
                    return (jdk.incubator.foreign.Addressable)(jdk.incubator.foreign.MemoryAddress)_GMemVTable.calloc$MH.invokeExact(symbol, _x0, _x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress calloc$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GMemVTable.calloc$VH.get(seg);
    }
    ...
    public static MemoryAddress calloc$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GMemVTable.calloc$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (long _x0) -> {
                try {
                    return (jdk.incubator.foreign.Addressable)(jdk.incubator.foreign.MemoryAddress)_GMemVTable.try_malloc$MH.invokeExact(symbol, _x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress try_malloc$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GMemVTable.try_malloc$VH.get(seg);
    }
    ...
    public static MemoryAddress try_malloc$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GMemVTable.try_malloc$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (jdk.incubator.foreign.MemoryAddress _x0, long _x1) -> {
                try {
                    return (jdk.incubator.foreign.Addressable)(jdk.incubator.foreign.MemoryAddress)_GMemVTable.try_realloc$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, _x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress try_realloc$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GMemVTable.try_realloc$VH.get(seg);
    }
    ...
    public static MemoryAddress try_realloc$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GMemVTable.try_realloc$VH.get(seg.asSlice(index*sizeof()));
    }
