...
public class _GdkEventOwnerChange {
    ...
    public static MemoryAddress window$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventOwnerChange.window$VH.get(seg);
    }
    ...
    public static MemoryAddress window$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventOwnerChange.window$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress owner$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventOwnerChange.owner$VH.get(seg);
    }
    ...
    public static MemoryAddress owner$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventOwnerChange.owner$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress selection$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventOwnerChange.selection$VH.get(seg);
    }
    ...
    public static MemoryAddress selection$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventOwnerChange.selection$VH.get(seg.asSlice(index*sizeof()));
    }
