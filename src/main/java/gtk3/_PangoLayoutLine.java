...
public class _PangoLayoutLine {
    ...
    public static MemoryAddress layout$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoLayoutLine.layout$VH.get(seg);
    }
    ...
    public static MemoryAddress layout$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoLayoutLine.layout$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress runs$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoLayoutLine.runs$VH.get(seg);
    }
    ...
    public static MemoryAddress runs$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoLayoutLine.runs$VH.get(seg.asSlice(index*sizeof()));
    }
