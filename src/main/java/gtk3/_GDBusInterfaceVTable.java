...
public class _GDBusInterfaceVTable {
    ...
    public static MemoryAddress method_call$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusInterfaceVTable.method_call$VH.get(seg);
    }
    ...
    public static MemoryAddress method_call$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusInterfaceVTable.method_call$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static GDBusInterfaceMethodCallFunc method_call (MemorySegment segment, ResourceScope scope) {
    ...
    public static MemoryAddress get_property$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusInterfaceVTable.get_property$VH.get(seg);
    }
    ...
    public static MemoryAddress get_property$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusInterfaceVTable.get_property$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static GDBusInterfaceGetPropertyFunc get_property (MemorySegment segment, ResourceScope scope) {
    ...
    public static MemoryAddress set_property$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusInterfaceVTable.set_property$VH.get(seg);
    }
    ...
    public static MemoryAddress set_property$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusInterfaceVTable.set_property$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static GDBusInterfaceSetPropertyFunc set_property (MemorySegment segment, ResourceScope scope) {
