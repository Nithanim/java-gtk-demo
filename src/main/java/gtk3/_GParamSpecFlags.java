...
public class _GParamSpecFlags {
    ...
    public static MemoryAddress flags_class$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GParamSpecFlags.flags_class$VH.get(seg);
    }
    ...
    public static MemoryAddress flags_class$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GParamSpecFlags.flags_class$VH.get(seg.asSlice(index*sizeof()));
    }
