...
return (jdk.incubator.foreign.MemoryAddress _x0) -> {
                try {
                    return (int)_GSocketAddressClass.get_family$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0);
                } catch (Throwable ex$) {
...
return (jdk.incubator.foreign.MemoryAddress _x0) -> {
                try {
                    return (long)_GSocketAddressClass.get_native_size$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public interface to_native {
        ...
        int apply(jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1, long _x2, jdk.incubator.foreign.MemoryAddress _x3);
...
return (jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1, long _x2, jdk.incubator.foreign.MemoryAddress _x3) -> {
                try {
                    return (int)_GSocketAddressClass.to_native$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, (jdk.incubator.foreign.Addressable)_x1, _x2, (jdk.incubator.foreign.Addressable)_x3);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
