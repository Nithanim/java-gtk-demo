...
return (jdk.incubator.foreign.MemoryAddress _x0) -> {
                try {
                    return (int)_GIconIface.hash$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress hash$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GIconIface.hash$VH.get(seg);
    }
    ...
    public static MemoryAddress hash$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GIconIface.hash$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1) -> {
                try {
                    return (int)_GIconIface.equal$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, (jdk.incubator.foreign.Addressable)_x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress equal$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GIconIface.equal$VH.get(seg);
    }
    ...
    public static MemoryAddress equal$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GIconIface.equal$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1, jdk.incubator.foreign.MemoryAddress _x2) -> {
                try {
                    return (int)_GIconIface.to_tokens$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, (jdk.incubator.foreign.Addressable)_x1, (jdk.incubator.foreign.Addressable)_x2);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress to_tokens$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GIconIface.to_tokens$VH.get(seg);
    }
    ...
    public static MemoryAddress to_tokens$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GIconIface.to_tokens$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public interface from_tokens {
        ...
        jdk.incubator.foreign.Addressable apply(jdk.incubator.foreign.MemoryAddress _x0, int _x1, int _x2, jdk.incubator.foreign.MemoryAddress _x3);
...
return (jdk.incubator.foreign.MemoryAddress _x0, int _x1, int _x2, jdk.incubator.foreign.MemoryAddress _x3) -> {
                try {
                    return (jdk.incubator.foreign.Addressable)(jdk.incubator.foreign.MemoryAddress)_GIconIface.from_tokens$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, _x1, _x2, (jdk.incubator.foreign.Addressable)_x3);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress from_tokens$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GIconIface.from_tokens$VH.get(seg);
    }
    ...
    public static MemoryAddress from_tokens$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GIconIface.from_tokens$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (jdk.incubator.foreign.MemoryAddress _x0) -> {
                try {
                    return (jdk.incubator.foreign.Addressable)(jdk.incubator.foreign.MemoryAddress)_GIconIface.serialize$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress serialize$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GIconIface.serialize$VH.get(seg);
    }
    ...
    public static MemoryAddress serialize$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GIconIface.serialize$VH.get(seg.asSlice(index*sizeof()));
    }
