...
class constants$481 {
    ...
    static final MethodHandle g_binding_get_target_property$MH = RuntimeHelper.downcallHandle(
        ...
        constants$481.g_binding_get_target_property$FUNC, false
    );
    ...
    static final MethodHandle g_binding_unbind$MH = RuntimeHelper.downcallHandle(
        "g_binding_unbind",
        constants$481.g_binding_unbind$FUNC, false
    );
    ...
    static final MethodHandle g_object_bind_property$MH = RuntimeHelper.downcallHandle(
        ...
        constants$481.g_object_bind_property$FUNC, false
    );
    ...
    static final MethodHandle g_object_bind_property_full$MH = RuntimeHelper.downcallHandle(
        ...
        constants$481.g_object_bind_property_full$FUNC, false
    );
    ...
    static final MethodHandle g_object_bind_property_with_closures$MH = RuntimeHelper.downcallHandle(
        ...
        constants$481.g_object_bind_property_with_closures$FUNC, false
    );
    ...
    static final MethodHandle g_enum_get_value$MH = RuntimeHelper.downcallHandle(
        "g_enum_get_value",
        constants$481.g_enum_get_value$FUNC, false
    );
}
