...
public class _GtkRecentChooserMenuClass {
    ...
    static final MethodHandle gtk_recent1$MH = RuntimeHelper.downcallHandle(
        _GtkRecentChooserMenuClass.gtk_recent1$FUNC, false
    );
    public interface gtk_recent1 {

        void apply();
        static NativeSymbol allocate(gtk_recent1 fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(gtk_recent1.class, fi, _GtkRecentChooserMenuClass.gtk_recent1$FUNC, "()V", scope);
        }
        static gtk_recent1 ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("gtk_recent1::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return () -> {
                try {
                    _GtkRecentChooserMenuClass.gtk_recent1$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress gtk_recent1$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkRecentChooserMenuClass.gtk_recent1$VH.get(seg);
    }
    ...
    public static MemoryAddress gtk_recent1$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkRecentChooserMenuClass.gtk_recent1$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static gtk_recent1 gtk_recent1 (MemorySegment segment, ResourceScope scope) {
    ...
    static final MethodHandle gtk_recent2$MH = RuntimeHelper.downcallHandle(
        _GtkRecentChooserMenuClass.gtk_recent2$FUNC, false
    );
    public interface gtk_recent2 {

        void apply();
        static NativeSymbol allocate(gtk_recent2 fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(gtk_recent2.class, fi, _GtkRecentChooserMenuClass.gtk_recent2$FUNC, "()V", scope);
        }
        static gtk_recent2 ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("gtk_recent2::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return () -> {
                try {
                    _GtkRecentChooserMenuClass.gtk_recent2$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress gtk_recent2$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkRecentChooserMenuClass.gtk_recent2$VH.get(seg);
    }
    ...
    public static MemoryAddress gtk_recent2$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkRecentChooserMenuClass.gtk_recent2$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static gtk_recent2 gtk_recent2 (MemorySegment segment, ResourceScope scope) {
    ...
    static final MethodHandle gtk_recent3$MH = RuntimeHelper.downcallHandle(
        _GtkRecentChooserMenuClass.gtk_recent3$FUNC, false
    );
    public interface gtk_recent3 {

        void apply();
        static NativeSymbol allocate(gtk_recent3 fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(gtk_recent3.class, fi, _GtkRecentChooserMenuClass.gtk_recent3$FUNC, "()V", scope);
        }
        static gtk_recent3 ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("gtk_recent3::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return () -> {
                try {
                    _GtkRecentChooserMenuClass.gtk_recent3$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress gtk_recent3$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkRecentChooserMenuClass.gtk_recent3$VH.get(seg);
    }
    ...
    public static MemoryAddress gtk_recent3$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkRecentChooserMenuClass.gtk_recent3$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static gtk_recent3 gtk_recent3 (MemorySegment segment, ResourceScope scope) {
    ...
    static final MethodHandle gtk_recent4$MH = RuntimeHelper.downcallHandle(
        _GtkRecentChooserMenuClass.gtk_recent4$FUNC, false
    );
    public interface gtk_recent4 {

        void apply();
        static NativeSymbol allocate(gtk_recent4 fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(gtk_recent4.class, fi, _GtkRecentChooserMenuClass.gtk_recent4$FUNC, "()V", scope);
        }
        static gtk_recent4 ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("gtk_recent4::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return () -> {
                try {
                    _GtkRecentChooserMenuClass.gtk_recent4$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress gtk_recent4$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkRecentChooserMenuClass.gtk_recent4$VH.get(seg);
    }
    ...
    public static MemoryAddress gtk_recent4$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkRecentChooserMenuClass.gtk_recent4$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static gtk_recent4 gtk_recent4 (MemorySegment segment, ResourceScope scope) {
