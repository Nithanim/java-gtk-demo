...
public class GTestLogMsg {
    ...
    public static MemoryAddress strings$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)GTestLogMsg.strings$VH.get(seg);
    }
    ...
    public static MemoryAddress strings$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)GTestLogMsg.strings$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress nums$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)GTestLogMsg.nums$VH.get(seg);
    }
    ...
    public static MemoryAddress nums$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)GTestLogMsg.nums$VH.get(seg.asSlice(index*sizeof()));
    }
