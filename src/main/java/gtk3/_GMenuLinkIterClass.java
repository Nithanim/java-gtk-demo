...
public class _GMenuLinkIterClass {
    ...
    static final MethodHandle get_next$MH = RuntimeHelper.downcallHandle(
        _GMenuLinkIterClass.get_next$FUNC, false
    );
    public interface get_next {
        ...
        static NativeSymbol allocate(get_next fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(get_next.class, fi, _GMenuLinkIterClass.get_next$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;)I", scope);
        }
...
return (jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1, jdk.incubator.foreign.MemoryAddress _x2) -> {
                try {
                    return (int)_GMenuLinkIterClass.get_next$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, (jdk.incubator.foreign.Addressable)_x1, (jdk.incubator.foreign.Addressable)_x2);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress get_next$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GMenuLinkIterClass.get_next$VH.get(seg);
    }
    ...
    public static MemoryAddress get_next$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GMenuLinkIterClass.get_next$VH.get(seg.asSlice(index*sizeof()));
    }
