...
public class _GRecMutex {
    ...
    public static MemoryAddress p$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GRecMutex.p$VH.get(seg);
    }
    ...
    public static MemoryAddress p$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GRecMutex.p$VH.get(seg.asSlice(index*sizeof()));
    }
