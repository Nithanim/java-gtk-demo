...
class constants$685 {
    ...
    static final MethodHandle g_file_info_get_modification_date_time$MH = RuntimeHelper.downcallHandle(
        ...
        constants$685.g_file_info_get_modification_date_time$FUNC, false
    );
    ...
    static final MethodHandle g_file_info_get_symlink_target$MH = RuntimeHelper.downcallHandle(
        ...
        constants$685.g_file_info_get_symlink_target$FUNC, false
    );
    ...
    static final MethodHandle g_file_info_get_etag$MH = RuntimeHelper.downcallHandle(
        ...
        constants$685.g_file_info_get_etag$FUNC, false
    );
    ...
    static final MethodHandle g_file_info_get_sort_order$MH = RuntimeHelper.downcallHandle(
        ...
        constants$685.g_file_info_get_sort_order$FUNC, false
    );
    ...
    static final MethodHandle g_file_info_set_attribute_mask$MH = RuntimeHelper.downcallHandle(
        ...
        constants$685.g_file_info_set_attribute_mask$FUNC, false
    );
    ...
    static final MethodHandle g_file_info_unset_attribute_mask$MH = RuntimeHelper.downcallHandle(
        ...
        constants$685.g_file_info_unset_attribute_mask$FUNC, false
    );
}
