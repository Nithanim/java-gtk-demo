...
class constants$1190 {
    ...
    static final MethodHandle gdk_event_peek$MH = RuntimeHelper.downcallHandle(
        "gdk_event_peek",
        constants$1190.gdk_event_peek$FUNC, false
    );
    ...
    static final MethodHandle gdk_event_put$MH = RuntimeHelper.downcallHandle(
        "gdk_event_put",
        constants$1190.gdk_event_put$FUNC, false
    );
    ...
    static final MethodHandle gdk_event_new$MH = RuntimeHelper.downcallHandle(
        "gdk_event_new",
        constants$1190.gdk_event_new$FUNC, false
    );
    ...
    static final MethodHandle gdk_event_copy$MH = RuntimeHelper.downcallHandle(
        "gdk_event_copy",
        constants$1190.gdk_event_copy$FUNC, false
    );
    ...
    static final MethodHandle gdk_event_free$MH = RuntimeHelper.downcallHandle(
        "gdk_event_free",
        constants$1190.gdk_event_free$FUNC, false
    );
    ...
    static final MethodHandle gdk_event_get_window$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1190.gdk_event_get_window$FUNC, false
    );
}
