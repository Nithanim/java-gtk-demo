...
public class _PangoAttrShape {
    ...
    public static MemoryAddress data$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoAttrShape.data$VH.get(seg);
    }
    ...
    public static MemoryAddress data$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoAttrShape.data$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress copy_func$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoAttrShape.copy_func$VH.get(seg);
    }
    ...
    public static MemoryAddress copy_func$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoAttrShape.copy_func$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static PangoAttrDataCopyFunc copy_func (MemorySegment segment, ResourceScope scope) {
    ...
    public static MemoryAddress destroy_func$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoAttrShape.destroy_func$VH.get(seg);
    }
    ...
    public static MemoryAddress destroy_func$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoAttrShape.destroy_func$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static GDestroyNotify destroy_func (MemorySegment segment, ResourceScope scope) {
