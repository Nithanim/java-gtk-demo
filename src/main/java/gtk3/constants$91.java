...
class constants$91 {
    ...
    static final MethodHandle g_bookmark_file_remove_item$MH = RuntimeHelper.downcallHandle(
        ...
        constants$91.g_bookmark_file_remove_item$FUNC, false
    );
    ...
    static final MethodHandle g_bookmark_file_move_item$MH = RuntimeHelper.downcallHandle(
        ...
        constants$91.g_bookmark_file_move_item$FUNC, false
    );
    ...
    static final MethodHandle g_bytes_new$MH = RuntimeHelper.downcallHandle(
        "g_bytes_new",
        constants$91.g_bytes_new$FUNC, false
    );
    ...
    static final MethodHandle g_bytes_new_take$MH = RuntimeHelper.downcallHandle(
        "g_bytes_new_take",
        constants$91.g_bytes_new_take$FUNC, false
    );
    ...
    static final MethodHandle g_bytes_new_static$MH = RuntimeHelper.downcallHandle(
        "g_bytes_new_static",
        constants$91.g_bytes_new_static$FUNC, false
    );
    ...
    static final MethodHandle g_bytes_new_with_free_func$MH = RuntimeHelper.downcallHandle(
        ...
        constants$91.g_bytes_new_with_free_func$FUNC, false
    );
}
