...
public class _AtkObject {
    ...
    public static MemoryAddress description$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkObject.description$VH.get(seg);
    }
    ...
    public static MemoryAddress description$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkObject.description$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress name$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkObject.name$VH.get(seg);
    }
    ...
    public static MemoryAddress name$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkObject.name$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress accessible_parent$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkObject.accessible_parent$VH.get(seg);
    }
    ...
    public static MemoryAddress accessible_parent$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkObject.accessible_parent$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress relation_set$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkObject.relation_set$VH.get(seg);
    }
    ...
    public static MemoryAddress relation_set$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkObject.relation_set$VH.get(seg.asSlice(index*sizeof()));
    }
