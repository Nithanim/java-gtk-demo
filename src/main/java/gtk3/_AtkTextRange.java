...
public class _AtkTextRange {
    ...
    public static MemoryAddress content$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkTextRange.content$VH.get(seg);
    }
    ...
    public static MemoryAddress content$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkTextRange.content$VH.get(seg.asSlice(index*sizeof()));
    }
