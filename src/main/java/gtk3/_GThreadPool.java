...
public class _GThreadPool {
    ...
    public static MemoryAddress func$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GThreadPool.func$VH.get(seg);
    }
    ...
    public static MemoryAddress func$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GThreadPool.func$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static GFunc func (MemorySegment segment, ResourceScope scope) {
    ...
    public static MemoryAddress user_data$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GThreadPool.user_data$VH.get(seg);
    }
    ...
    public static MemoryAddress user_data$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GThreadPool.user_data$VH.get(seg.asSlice(index*sizeof()));
    }
