...
class constants$654 {
    ...
    static final MethodHandle g_file_get_parent$MH = RuntimeHelper.downcallHandle(
        "g_file_get_parent",
        constants$654.g_file_get_parent$FUNC, false
    );
    ...
    static final MethodHandle g_file_has_parent$MH = RuntimeHelper.downcallHandle(
        "g_file_has_parent",
        constants$654.g_file_has_parent$FUNC, false
    );
    ...
    static final MethodHandle g_file_get_child$MH = RuntimeHelper.downcallHandle(
        "g_file_get_child",
        constants$654.g_file_get_child$FUNC, false
    );
    ...
    static final MethodHandle g_file_get_child_for_display_name$MH = RuntimeHelper.downcallHandle(
        ...
        constants$654.g_file_get_child_for_display_name$FUNC, false
    );
    ...
    static final MethodHandle g_file_has_prefix$MH = RuntimeHelper.downcallHandle(
        "g_file_has_prefix",
        constants$654.g_file_has_prefix$FUNC, false
    );
    ...
    static final MethodHandle g_file_get_relative_path$MH = RuntimeHelper.downcallHandle(
        ...
        constants$654.g_file_get_relative_path$FUNC, false
    );
}
