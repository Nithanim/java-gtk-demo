...
class constants$179 {
    ...
    static final VarHandle g_utf8_skip$VH = constants$179.g_utf8_skip$LAYOUT.varHandle();
    static final MemorySegment g_utf8_skip$SEGMENT = RuntimeHelper.lookupGlobalVariable("g_utf8_skip", constants$179.g_utf8_skip$LAYOUT);
    ...
    static final MethodHandle g_utf8_get_char$MH = RuntimeHelper.downcallHandle(
        "g_utf8_get_char",
        constants$179.g_utf8_get_char$FUNC, false
    );
    ...
    static final MethodHandle g_utf8_get_char_validated$MH = RuntimeHelper.downcallHandle(
        ...
        constants$179.g_utf8_get_char_validated$FUNC, false
    );
    ...
    static final MethodHandle g_utf8_offset_to_pointer$MH = RuntimeHelper.downcallHandle(
        ...
        constants$179.g_utf8_offset_to_pointer$FUNC, false
    );
}
