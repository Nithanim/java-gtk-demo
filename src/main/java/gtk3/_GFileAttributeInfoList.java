...
public class _GFileAttributeInfoList {
    ...
    public static MemoryAddress infos$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GFileAttributeInfoList.infos$VH.get(seg);
    }
    ...
    public static MemoryAddress infos$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GFileAttributeInfoList.infos$VH.get(seg.asSlice(index*sizeof()));
    }
