...
public class _GtkTreeIter {
    ...
    public static MemoryAddress user_data$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkTreeIter.user_data$VH.get(seg);
    }
    ...
    public static MemoryAddress user_data$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkTreeIter.user_data$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress user_data2$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkTreeIter.user_data2$VH.get(seg);
    }
    ...
    public static MemoryAddress user_data2$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkTreeIter.user_data2$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress user_data3$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkTreeIter.user_data3$VH.get(seg);
    }
    ...
    public static MemoryAddress user_data3$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkTreeIter.user_data3$VH.get(seg.asSlice(index*sizeof()));
    }
