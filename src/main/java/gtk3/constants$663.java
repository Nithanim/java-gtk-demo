...
class constants$663 {
    ...
    static final MethodHandle g_file_copy$MH = RuntimeHelper.downcallHandle(
        "g_file_copy",
        constants$663.g_file_copy$FUNC, false
    );
    ...
    static final MethodHandle g_file_copy_async$MH = RuntimeHelper.downcallHandle(
        "g_file_copy_async",
        constants$663.g_file_copy_async$FUNC, false
    );
    ...
    static final MethodHandle g_file_copy_finish$MH = RuntimeHelper.downcallHandle(
        "g_file_copy_finish",
        constants$663.g_file_copy_finish$FUNC, false
    );
    ...
    static final MethodHandle g_file_move$MH = RuntimeHelper.downcallHandle(
        "g_file_move",
        constants$663.g_file_move$FUNC, false
    );
    ...
    static final MethodHandle g_file_make_directory$MH = RuntimeHelper.downcallHandle(
        ...
        constants$663.g_file_make_directory$FUNC, false
    );
    ...
    static final MethodHandle g_file_make_directory_async$MH = RuntimeHelper.downcallHandle(
        ...
        constants$663.g_file_make_directory_async$FUNC, false
    );
}
