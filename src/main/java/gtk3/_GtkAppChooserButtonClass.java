...
public class _GtkAppChooserButtonClass {
    ...
    static final MethodHandle custom_item_activated$MH = RuntimeHelper.downcallHandle(
        _GtkAppChooserButtonClass.custom_item_activated$FUNC, false
    );
    public interface custom_item_activated {
        ...
        static NativeSymbol allocate(custom_item_activated fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(custom_item_activated.class, fi, _GtkAppChooserButtonClass.custom_item_activated$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;)V", scope);
        }
        static custom_item_activated ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("custom_item_activated::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return (jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1) -> {
                try {
                    _GtkAppChooserButtonClass.custom_item_activated$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, (jdk.incubator.foreign.Addressable)_x1);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress custom_item_activated$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkAppChooserButtonClass.custom_item_activated$VH.get(seg);
    }
    ...
    public static MemoryAddress custom_item_activated$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkAppChooserButtonClass.custom_item_activated$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static custom_item_activated custom_item_activated (MemorySegment segment, ResourceScope scope) {
