...
public class _GInterfaceInfo {
    ...
    public static MemoryAddress interface_init$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GInterfaceInfo.interface_init$VH.get(seg);
    }
    ...
    public static MemoryAddress interface_init$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GInterfaceInfo.interface_init$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress interface_finalize$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GInterfaceInfo.interface_finalize$VH.get(seg);
    }
    ...
    public static MemoryAddress interface_finalize$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GInterfaceInfo.interface_finalize$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress interface_data$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GInterfaceInfo.interface_data$VH.get(seg);
    }
    ...
    public static MemoryAddress interface_data$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GInterfaceInfo.interface_data$VH.get(seg.asSlice(index*sizeof()));
    }
