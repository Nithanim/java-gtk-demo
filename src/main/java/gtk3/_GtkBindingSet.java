...
public class _GtkBindingSet {
    ...
    public static MemoryAddress set_name$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkBindingSet.set_name$VH.get(seg);
    }
    ...
    public static MemoryAddress set_name$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkBindingSet.set_name$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress widget_path_pspecs$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkBindingSet.widget_path_pspecs$VH.get(seg);
    }
    ...
    public static MemoryAddress widget_path_pspecs$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkBindingSet.widget_path_pspecs$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress widget_class_pspecs$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkBindingSet.widget_class_pspecs$VH.get(seg);
    }
    ...
    public static MemoryAddress widget_class_pspecs$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkBindingSet.widget_class_pspecs$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress class_branch_pspecs$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkBindingSet.class_branch_pspecs$VH.get(seg);
    }
    ...
    public static MemoryAddress class_branch_pspecs$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkBindingSet.class_branch_pspecs$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress entries$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkBindingSet.entries$VH.get(seg);
    }
    ...
    public static MemoryAddress entries$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkBindingSet.entries$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress current$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkBindingSet.current$VH.get(seg);
    }
    ...
    public static MemoryAddress current$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkBindingSet.current$VH.get(seg.asSlice(index*sizeof()));
    }
