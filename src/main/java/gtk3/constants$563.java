...
class constants$563 {
    ...
    static final MethodHandle fexecve$MH = RuntimeHelper.downcallHandle(
        "fexecve",
        constants$563.fexecve$FUNC, false
    );
    ...
    static final MethodHandle execv$MH = RuntimeHelper.downcallHandle(
        "execv",
        constants$563.execv$FUNC, false
    );
    ...
    static final MethodHandle execle$MH = RuntimeHelper.downcallHandle(
        "execle",
        constants$563.execle$FUNC, true
    );
    ...
    static final MethodHandle execvp$MH = RuntimeHelper.downcallHandle(
        "execvp",
        constants$563.execvp$FUNC, false
    );
    ...
    static final MethodHandle execlp$MH = RuntimeHelper.downcallHandle(
        "execlp",
        constants$563.execlp$FUNC, true
    );
}
