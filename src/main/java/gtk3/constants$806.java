...
class constants$806 {
    ...
    static final MethodHandle g_socket_receive_message$MH = RuntimeHelper.downcallHandle(
        ...
        constants$806.g_socket_receive_message$FUNC, false
    );
    ...
    static final MethodHandle g_socket_send_message$MH = RuntimeHelper.downcallHandle(
        ...
        constants$806.g_socket_send_message$FUNC, false
    );
    ...
    static final MethodHandle g_socket_receive_messages$MH = RuntimeHelper.downcallHandle(
        ...
        constants$806.g_socket_receive_messages$FUNC, false
    );
    ...
    static final MethodHandle g_socket_send_messages$MH = RuntimeHelper.downcallHandle(
        ...
        constants$806.g_socket_send_messages$FUNC, false
    );
    ...
    static final MethodHandle g_socket_close$MH = RuntimeHelper.downcallHandle(
        "g_socket_close",
        constants$806.g_socket_close$FUNC, false
    );
    ...
    static final MethodHandle g_socket_shutdown$MH = RuntimeHelper.downcallHandle(
        "g_socket_shutdown",
        constants$806.g_socket_shutdown$FUNC, false
    );
}
