...
public class _GdkEventCrossing {
    ...
    public static MemoryAddress window$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventCrossing.window$VH.get(seg);
    }
    ...
    public static MemoryAddress window$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventCrossing.window$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress subwindow$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventCrossing.subwindow$VH.get(seg);
    }
    ...
    public static MemoryAddress subwindow$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventCrossing.subwindow$VH.get(seg.asSlice(index*sizeof()));
    }
