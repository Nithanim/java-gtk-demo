...
class constants$798 {
    ...
    static final MethodHandle g_simple_proxy_resolver_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$798.g_simple_proxy_resolver_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_simple_proxy_resolver_new$MH = RuntimeHelper.downcallHandle(
        ...
        constants$798.g_simple_proxy_resolver_new$FUNC, false
    );
    ...
    static final MethodHandle g_simple_proxy_resolver_set_default_proxy$MH = RuntimeHelper.downcallHandle(
        ...
        constants$798.g_simple_proxy_resolver_set_default_proxy$FUNC, false
    );
    ...
    static final MethodHandle g_simple_proxy_resolver_set_ignore_hosts$MH = RuntimeHelper.downcallHandle(
        ...
        constants$798.g_simple_proxy_resolver_set_ignore_hosts$FUNC, false
    );
    ...
    static final MethodHandle g_simple_proxy_resolver_set_uri_proxy$MH = RuntimeHelper.downcallHandle(
        ...
        constants$798.g_simple_proxy_resolver_set_uri_proxy$FUNC, false
    );
    ...
    static final MethodHandle g_socket_get_type$MH = RuntimeHelper.downcallHandle(
        "g_socket_get_type",
        constants$798.g_socket_get_type$FUNC, false
    );
}
