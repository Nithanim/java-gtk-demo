...
public class _GtkBindingSignal {
    ...
    public static MemoryAddress next$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkBindingSignal.next$VH.get(seg);
    }
    ...
    public static MemoryAddress next$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkBindingSignal.next$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress signal_name$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkBindingSignal.signal_name$VH.get(seg);
    }
    ...
    public static MemoryAddress signal_name$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkBindingSignal.signal_name$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress args$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkBindingSignal.args$VH.get(seg);
    }
    ...
    public static MemoryAddress args$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkBindingSignal.args$VH.get(seg.asSlice(index*sizeof()));
    }
