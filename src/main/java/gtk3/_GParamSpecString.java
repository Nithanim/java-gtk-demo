...
public class _GParamSpecString {
    ...
    public static MemoryAddress default_value$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GParamSpecString.default_value$VH.get(seg);
    }
    ...
    public static MemoryAddress default_value$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GParamSpecString.default_value$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress cset_first$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GParamSpecString.cset_first$VH.get(seg);
    }
    ...
    public static MemoryAddress cset_first$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GParamSpecString.cset_first$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress cset_nth$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GParamSpecString.cset_nth$VH.get(seg);
    }
    ...
    public static MemoryAddress cset_nth$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GParamSpecString.cset_nth$VH.get(seg.asSlice(index*sizeof()));
    }
