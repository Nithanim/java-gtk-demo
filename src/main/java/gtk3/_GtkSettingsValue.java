...
public class _GtkSettingsValue {
    ...
    public static MemoryAddress origin$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkSettingsValue.origin$VH.get(seg);
    }
    ...
    public static MemoryAddress origin$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkSettingsValue.origin$VH.get(seg.asSlice(index*sizeof()));
    }
