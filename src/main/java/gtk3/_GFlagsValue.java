...
public class _GFlagsValue {
    ...
    public static MemoryAddress value_name$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GFlagsValue.value_name$VH.get(seg);
    }
    ...
    public static MemoryAddress value_name$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GFlagsValue.value_name$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress value_nick$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GFlagsValue.value_nick$VH.get(seg);
    }
    ...
    public static MemoryAddress value_nick$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GFlagsValue.value_nick$VH.get(seg.asSlice(index*sizeof()));
    }
