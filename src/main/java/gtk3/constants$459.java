...
class constants$459 {
    ...
    static final MethodHandle g_ptr_array_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$459.g_ptr_array_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_bytes_get_type$MH = RuntimeHelper.downcallHandle(
        "g_bytes_get_type",
        constants$459.g_bytes_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_variant_type_get_gtype$MH = RuntimeHelper.downcallHandle(
        ...
        constants$459.g_variant_type_get_gtype$FUNC, false
    );
    ...
    static final MethodHandle g_regex_get_type$MH = RuntimeHelper.downcallHandle(
        "g_regex_get_type",
        constants$459.g_regex_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_match_info_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$459.g_match_info_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_error_get_type$MH = RuntimeHelper.downcallHandle(
        "g_error_get_type",
        constants$459.g_error_get_type$FUNC, false
    );
}
