...
class constants$857 {
    ...
    static final MethodHandle g_vfs_get_default$MH = RuntimeHelper.downcallHandle(
        "g_vfs_get_default",
        constants$857.g_vfs_get_default$FUNC, false
    );
    ...
    static final MethodHandle g_vfs_get_local$MH = RuntimeHelper.downcallHandle(
        "g_vfs_get_local",
        constants$857.g_vfs_get_local$FUNC, false
    );
    ...
    static final MethodHandle g_vfs_register_uri_scheme$MH = RuntimeHelper.downcallHandle(
        ...
        constants$857.g_vfs_register_uri_scheme$FUNC, false
    );
    ...
    static final MethodHandle g_vfs_unregister_uri_scheme$MH = RuntimeHelper.downcallHandle(
        ...
        constants$857.g_vfs_unregister_uri_scheme$FUNC, false
    );
    ...
    static final MethodHandle g_volume_get_type$MH = RuntimeHelper.downcallHandle(
        "g_volume_get_type",
        constants$857.g_volume_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_volume_get_name$MH = RuntimeHelper.downcallHandle(
        "g_volume_get_name",
        constants$857.g_volume_get_name$FUNC, false
    );
}
