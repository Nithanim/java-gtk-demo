...
class constants$465 {
    ...
    static final MethodHandle g_value_dup_boxed$MH = RuntimeHelper.downcallHandle(
        "g_value_dup_boxed",
        constants$465.g_value_dup_boxed$FUNC, false
    );
    ...
    static final MethodHandle g_boxed_type_register_static$MH = RuntimeHelper.downcallHandle(
        ...
        constants$465.g_boxed_type_register_static$FUNC, false
    );
    ...
    static final MethodHandle g_closure_get_type$MH = RuntimeHelper.downcallHandle(
        "g_closure_get_type",
        constants$465.g_closure_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_value_get_type$MH = RuntimeHelper.downcallHandle(
        "g_value_get_type",
        constants$465.g_value_get_type$FUNC, false
    );
    ...
    static final MethodHandle GObjectGetPropertyFunc$MH = RuntimeHelper.downcallHandle(
        constants$465.GObjectGetPropertyFunc$FUNC, false
    );
}
