...
public class _AtkHypertextIface {
    ...
    static final MethodHandle get_link$MH = RuntimeHelper.downcallHandle(
        _AtkHypertextIface.get_link$FUNC, false
    );
    public interface get_link {

        jdk.incubator.foreign.Addressable apply(jdk.incubator.foreign.MemoryAddress _x0, int _x1);
        static NativeSymbol allocate(get_link fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(get_link.class, fi, _AtkHypertextIface.get_link$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;I)Ljdk/incubator/foreign/Addressable;", scope);
        }
        static get_link ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("get_link::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return (jdk.incubator.foreign.MemoryAddress _x0, int _x1) -> {
                try {
                    return (jdk.incubator.foreign.Addressable)(jdk.incubator.foreign.MemoryAddress)_AtkHypertextIface.get_link$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, _x1);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress get_link$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkHypertextIface.get_link$VH.get(seg);
    }
    ...
    public static MemoryAddress get_link$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkHypertextIface.get_link$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static get_link get_link (MemorySegment segment, ResourceScope scope) {
    ...
    static final MethodHandle get_n_links$MH = RuntimeHelper.downcallHandle(
        _AtkHypertextIface.get_n_links$FUNC, false
    );
    public interface get_n_links {

        int apply(jdk.incubator.foreign.MemoryAddress _x0);
        static NativeSymbol allocate(get_n_links fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(get_n_links.class, fi, _AtkHypertextIface.get_n_links$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;)I", scope);
        }
        static get_n_links ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("get_n_links::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return (jdk.incubator.foreign.MemoryAddress _x0) -> {
                try {
                    return (int)_AtkHypertextIface.get_n_links$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress get_n_links$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkHypertextIface.get_n_links$VH.get(seg);
    }
    ...
    public static MemoryAddress get_n_links$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkHypertextIface.get_n_links$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static get_n_links get_n_links (MemorySegment segment, ResourceScope scope) {
    ...
    static final MethodHandle get_link_index$MH = RuntimeHelper.downcallHandle(
        _AtkHypertextIface.get_link_index$FUNC, false
    );
    public interface get_link_index {

        int apply(jdk.incubator.foreign.MemoryAddress _x0, int _x1);
        static NativeSymbol allocate(get_link_index fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(get_link_index.class, fi, _AtkHypertextIface.get_link_index$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;I)I", scope);
        }
        static get_link_index ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("get_link_index::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return (jdk.incubator.foreign.MemoryAddress _x0, int _x1) -> {
                try {
                    return (int)_AtkHypertextIface.get_link_index$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, _x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress get_link_index$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkHypertextIface.get_link_index$VH.get(seg);
    }
    ...
    public static MemoryAddress get_link_index$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkHypertextIface.get_link_index$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static get_link_index get_link_index (MemorySegment segment, ResourceScope scope) {
    ...
    static final MethodHandle link_selected$MH = RuntimeHelper.downcallHandle(
        _AtkHypertextIface.link_selected$FUNC, false
    );
    public interface link_selected {

        void apply(jdk.incubator.foreign.MemoryAddress _x0, int _x1);
        static NativeSymbol allocate(link_selected fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(link_selected.class, fi, _AtkHypertextIface.link_selected$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;I)V", scope);
        }
        static link_selected ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("link_selected::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return (jdk.incubator.foreign.MemoryAddress _x0, int _x1) -> {
                try {
                    _AtkHypertextIface.link_selected$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, _x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress link_selected$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkHypertextIface.link_selected$VH.get(seg);
    }
    ...
    public static MemoryAddress link_selected$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkHypertextIface.link_selected$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static link_selected link_selected (MemorySegment segment, ResourceScope scope) {
