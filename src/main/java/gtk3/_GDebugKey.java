...
public class _GDebugKey {
    ...
    public static MemoryAddress key$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GDebugKey.key$VH.get(seg);
    }
    ...
    public static MemoryAddress key$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GDebugKey.key$VH.get(seg.asSlice(index*sizeof()));
    }
