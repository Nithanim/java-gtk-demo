...
public class _GtkFixed {
    ...
    public static MemoryAddress priv$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkFixed.priv$VH.get(seg);
    }
    ...
    public static MemoryAddress priv$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkFixed.priv$VH.get(seg.asSlice(index*sizeof()));
    }
