...
public class _GLoadableIconIface {
    ...
    public interface load {
        ...
        jdk.incubator.foreign.Addressable apply(jdk.incubator.foreign.MemoryAddress _x0, int _x1, jdk.incubator.foreign.MemoryAddress _x2, jdk.incubator.foreign.MemoryAddress _x3, jdk.incubator.foreign.MemoryAddress _x4);
...
return (jdk.incubator.foreign.MemoryAddress _x0, int _x1, jdk.incubator.foreign.MemoryAddress _x2, jdk.incubator.foreign.MemoryAddress _x3, jdk.incubator.foreign.MemoryAddress _x4) -> {
                try {
                    return (jdk.incubator.foreign.Addressable)(jdk.incubator.foreign.MemoryAddress)_GLoadableIconIface.load$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, _x1, (jdk.incubator.foreign.Addressable)_x2, (jdk.incubator.foreign.Addressable)_x3, (jdk.incubator.foreign.Addressable)_x4);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress load$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GLoadableIconIface.load$VH.get(seg);
    }
    ...
    public static MemoryAddress load$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GLoadableIconIface.load$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (jdk.incubator.foreign.MemoryAddress _x0, int _x1, jdk.incubator.foreign.MemoryAddress _x2, jdk.incubator.foreign.MemoryAddress _x3, jdk.incubator.foreign.MemoryAddress _x4) -> {
                try {
                    _GLoadableIconIface.load_async$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, _x1, (jdk.incubator.foreign.Addressable)_x2, (jdk.incubator.foreign.Addressable)_x3, (jdk.incubator.foreign.Addressable)_x4);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress load_async$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GLoadableIconIface.load_async$VH.get(seg);
    }
    ...
    public static MemoryAddress load_async$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GLoadableIconIface.load_async$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1, jdk.incubator.foreign.MemoryAddress _x2, jdk.incubator.foreign.MemoryAddress _x3) -> {
                try {
                    return (jdk.incubator.foreign.Addressable)(jdk.incubator.foreign.MemoryAddress)_GLoadableIconIface.load_finish$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, (jdk.incubator.foreign.Addressable)_x1, (jdk.incubator.foreign.Addressable)_x2, (jdk.incubator.foreign.Addressable)_x3);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress load_finish$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GLoadableIconIface.load_finish$VH.get(seg);
    }
    ...
    public static MemoryAddress load_finish$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GLoadableIconIface.load_finish$VH.get(seg.asSlice(index*sizeof()));
    }
