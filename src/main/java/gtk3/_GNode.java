...
public class _GNode {
    ...
    public static MemoryAddress data$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GNode.data$VH.get(seg);
    }
    ...
    public static MemoryAddress data$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GNode.data$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress next$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GNode.next$VH.get(seg);
    }
    ...
    public static MemoryAddress next$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GNode.next$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress prev$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GNode.prev$VH.get(seg);
    }
    ...
    public static MemoryAddress prev$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GNode.prev$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress parent$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GNode.parent$VH.get(seg);
    }
    ...
    public static MemoryAddress parent$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GNode.parent$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress children$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GNode.children$VH.get(seg);
    }
    ...
    public static MemoryAddress children$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GNode.children$VH.get(seg.asSlice(index*sizeof()));
    }
