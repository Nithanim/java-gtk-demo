...
class constants$817 {
    ...
    static final MethodHandle g_socket_control_message_get_msg_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$817.g_socket_control_message_get_msg_type$FUNC, false
    );
    ...
    static final MethodHandle g_socket_control_message_serialize$MH = RuntimeHelper.downcallHandle(
        ...
        constants$817.g_socket_control_message_serialize$FUNC, false
    );
    ...
    static final MethodHandle g_socket_control_message_deserialize$MH = RuntimeHelper.downcallHandle(
        ...
        constants$817.g_socket_control_message_deserialize$FUNC, false
    );
    ...
    static final MethodHandle g_socket_listener_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$817.g_socket_listener_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_socket_listener_new$MH = RuntimeHelper.downcallHandle(
        ...
        constants$817.g_socket_listener_new$FUNC, false
    );
    ...
    static final MethodHandle g_socket_listener_set_backlog$MH = RuntimeHelper.downcallHandle(
        ...
        constants$817.g_socket_listener_set_backlog$FUNC, false
    );
}
