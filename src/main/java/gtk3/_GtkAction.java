...
public class _GtkAction {
    ...
    public static MemoryAddress private_data$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkAction.private_data$VH.get(seg);
    }
    ...
    public static MemoryAddress private_data$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkAction.private_data$VH.get(seg.asSlice(index*sizeof()));
    }
