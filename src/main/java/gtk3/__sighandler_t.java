...
public interface __sighandler_t {
    ...
    static NativeSymbol allocate(__sighandler_t fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(__sighandler_t.class, fi, constants$64.__sighandler_t$FUNC, "(I)V", scope);
    }
...
return (int _x0) -> {
            try {
                constants$64.__sighandler_t$MH.invokeExact(symbol, _x0);
            } catch (Throwable ex$) {
