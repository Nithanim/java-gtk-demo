...
class constants$302 {
    ...
    static final MethodHandle g_strdupv$MH = RuntimeHelper.downcallHandle(
        "g_strdupv",
        constants$302.g_strdupv$FUNC, false
    );
    ...
    static final MethodHandle g_strv_length$MH = RuntimeHelper.downcallHandle(
        "g_strv_length",
        constants$302.g_strv_length$FUNC, false
    );
    ...
    static final MethodHandle g_stpcpy$MH = RuntimeHelper.downcallHandle(
        "g_stpcpy",
        constants$302.g_stpcpy$FUNC, false
    );
    ...
    static final MethodHandle g_str_to_ascii$MH = RuntimeHelper.downcallHandle(
        "g_str_to_ascii",
        constants$302.g_str_to_ascii$FUNC, false
    );
    ...
    static final MethodHandle g_str_tokenize_and_fold$MH = RuntimeHelper.downcallHandle(
        ...
        constants$302.g_str_tokenize_and_fold$FUNC, false
    );
    ...
    static final MethodHandle g_str_match_string$MH = RuntimeHelper.downcallHandle(
        "g_str_match_string",
        constants$302.g_str_match_string$FUNC, false
    );
}
