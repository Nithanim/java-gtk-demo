...
class constants$314 {
    ...
    static final MethodHandle g_assertion_message_error$MH = RuntimeHelper.downcallHandle(
        ...
        constants$314.g_assertion_message_error$FUNC, false
    );
    ...
    static final MethodHandle g_test_add_vtable$MH = RuntimeHelper.downcallHandle(
        "g_test_add_vtable",
        constants$314.g_test_add_vtable$FUNC, false
    );
    ...
    static final MethodHandle g_test_log_type_name$MH = RuntimeHelper.downcallHandle(
        ...
        constants$314.g_test_log_type_name$FUNC, false
    );
    ...
    static final MethodHandle g_test_log_buffer_new$MH = RuntimeHelper.downcallHandle(
        ...
        constants$314.g_test_log_buffer_new$FUNC, false
    );
    ...
    static final MethodHandle g_test_log_buffer_free$MH = RuntimeHelper.downcallHandle(
        ...
        constants$314.g_test_log_buffer_free$FUNC, false
    );
}
