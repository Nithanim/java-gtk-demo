...
public class _GtkTableChild {
    ...
    public static MemoryAddress widget$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkTableChild.widget$VH.get(seg);
    }
    ...
    public static MemoryAddress widget$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkTableChild.widget$VH.get(seg.asSlice(index*sizeof()));
    }
