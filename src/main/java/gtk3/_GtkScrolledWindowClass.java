...
public class _GtkScrolledWindowClass {
    ...
    static final MethodHandle scroll_child$MH = RuntimeHelper.downcallHandle(
        _GtkScrolledWindowClass.scroll_child$FUNC, false
    );
    public interface scroll_child {

        int apply(jdk.incubator.foreign.MemoryAddress _x0, int _x1, int _x2);
        static NativeSymbol allocate(scroll_child fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(scroll_child.class, fi, _GtkScrolledWindowClass.scroll_child$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;II)I", scope);
        }
        static scroll_child ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("scroll_child::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return (jdk.incubator.foreign.MemoryAddress _x0, int _x1, int _x2) -> {
                try {
                    return (int)_GtkScrolledWindowClass.scroll_child$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, _x1, _x2);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress scroll_child$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkScrolledWindowClass.scroll_child$VH.get(seg);
    }
    ...
    public static MemoryAddress scroll_child$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkScrolledWindowClass.scroll_child$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static scroll_child scroll_child (MemorySegment segment, ResourceScope scope) {
    ...
    static final MethodHandle move_focus_out$MH = RuntimeHelper.downcallHandle(
        _GtkScrolledWindowClass.move_focus_out$FUNC, false
    );
    public interface move_focus_out {
        ...
        static NativeSymbol allocate(move_focus_out fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(move_focus_out.class, fi, _GtkScrolledWindowClass.move_focus_out$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;I)V", scope);
        }
...
return (jdk.incubator.foreign.MemoryAddress _x0, int _x1) -> {
                try {
                    _GtkScrolledWindowClass.move_focus_out$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, _x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress move_focus_out$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkScrolledWindowClass.move_focus_out$VH.get(seg);
    }
    ...
    public static MemoryAddress move_focus_out$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkScrolledWindowClass.move_focus_out$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final MethodHandle _gtk_reserved1$MH = RuntimeHelper.downcallHandle(
        _GtkScrolledWindowClass._gtk_reserved1$FUNC, false
    );
    public interface _gtk_reserved1 {

        void apply();
        static NativeSymbol allocate(_gtk_reserved1 fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(_gtk_reserved1.class, fi, _GtkScrolledWindowClass._gtk_reserved1$FUNC, "()V", scope);
        }
...
return () -> {
                try {
                    _GtkScrolledWindowClass._gtk_reserved1$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress _gtk_reserved1$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkScrolledWindowClass._gtk_reserved1$VH.get(seg);
    }
    ...
    public static MemoryAddress _gtk_reserved1$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkScrolledWindowClass._gtk_reserved1$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final MethodHandle _gtk_reserved2$MH = RuntimeHelper.downcallHandle(
        _GtkScrolledWindowClass._gtk_reserved2$FUNC, false
    );
    public interface _gtk_reserved2 {

        void apply();
        static NativeSymbol allocate(_gtk_reserved2 fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(_gtk_reserved2.class, fi, _GtkScrolledWindowClass._gtk_reserved2$FUNC, "()V", scope);
        }
...
return () -> {
                try {
                    _GtkScrolledWindowClass._gtk_reserved2$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress _gtk_reserved2$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkScrolledWindowClass._gtk_reserved2$VH.get(seg);
    }
    ...
    public static MemoryAddress _gtk_reserved2$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkScrolledWindowClass._gtk_reserved2$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final MethodHandle _gtk_reserved3$MH = RuntimeHelper.downcallHandle(
        _GtkScrolledWindowClass._gtk_reserved3$FUNC, false
    );
    public interface _gtk_reserved3 {

        void apply();
        static NativeSymbol allocate(_gtk_reserved3 fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(_gtk_reserved3.class, fi, _GtkScrolledWindowClass._gtk_reserved3$FUNC, "()V", scope);
        }
...
return () -> {
                try {
                    _GtkScrolledWindowClass._gtk_reserved3$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress _gtk_reserved3$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkScrolledWindowClass._gtk_reserved3$VH.get(seg);
    }
    ...
    public static MemoryAddress _gtk_reserved3$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkScrolledWindowClass._gtk_reserved3$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final MethodHandle _gtk_reserved4$MH = RuntimeHelper.downcallHandle(
        _GtkScrolledWindowClass._gtk_reserved4$FUNC, false
    );
    public interface _gtk_reserved4 {

        void apply();
        static NativeSymbol allocate(_gtk_reserved4 fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(_gtk_reserved4.class, fi, _GtkScrolledWindowClass._gtk_reserved4$FUNC, "()V", scope);
        }
...
return () -> {
                try {
                    _GtkScrolledWindowClass._gtk_reserved4$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress _gtk_reserved4$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkScrolledWindowClass._gtk_reserved4$VH.get(seg);
    }
    ...
    public static MemoryAddress _gtk_reserved4$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkScrolledWindowClass._gtk_reserved4$VH.get(seg.asSlice(index*sizeof()));
    }
