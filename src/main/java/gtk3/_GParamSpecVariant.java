...
public class _GParamSpecVariant {
    ...
    public static MemoryAddress type$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GParamSpecVariant.type$VH.get(seg);
    }
    ...
    public static MemoryAddress type$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GParamSpecVariant.type$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress default_value$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GParamSpecVariant.default_value$VH.get(seg);
    }
    ...
    public static MemoryAddress default_value$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GParamSpecVariant.default_value$VH.get(seg.asSlice(index*sizeof()));
    }
