...
class constants$123 {
    ...
    static final MethodHandle g_mem_is_system_malloc$MH = RuntimeHelper.downcallHandle(
        ...
        constants$123.g_mem_is_system_malloc$FUNC, false
    );
    static final  OfInt g_mem_gc_friendly$LAYOUT = Constants$root.C_INT$LAYOUT;
    static final VarHandle g_mem_gc_friendly$VH = constants$123.g_mem_gc_friendly$LAYOUT.varHandle();
    static final MemorySegment g_mem_gc_friendly$SEGMENT = RuntimeHelper.lookupGlobalVariable("g_mem_gc_friendly", constants$123.g_mem_gc_friendly$LAYOUT);
}
