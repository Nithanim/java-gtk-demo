...
class constants$335 {
    ...
    static final MethodHandle glib_check_version$MH = RuntimeHelper.downcallHandle(
        "glib_check_version",
        constants$335.glib_check_version$FUNC, false
    );
    ...
    static final MethodHandle g_mem_chunk_new$MH = RuntimeHelper.downcallHandle(
        "g_mem_chunk_new",
        constants$335.g_mem_chunk_new$FUNC, false
    );
    ...
    static final MethodHandle g_mem_chunk_destroy$MH = RuntimeHelper.downcallHandle(
        "g_mem_chunk_destroy",
        constants$335.g_mem_chunk_destroy$FUNC, false
    );
    ...
    static final MethodHandle g_mem_chunk_alloc$MH = RuntimeHelper.downcallHandle(
        "g_mem_chunk_alloc",
        constants$335.g_mem_chunk_alloc$FUNC, false
    );
    ...
    static final MethodHandle g_mem_chunk_alloc0$MH = RuntimeHelper.downcallHandle(
        "g_mem_chunk_alloc0",
        constants$335.g_mem_chunk_alloc0$FUNC, false
    );
    ...
    static final MethodHandle g_mem_chunk_free$MH = RuntimeHelper.downcallHandle(
        "g_mem_chunk_free",
        constants$335.g_mem_chunk_free$FUNC, false
    );
}
