...
public class _GInputMessage {
    ...
    public static MemoryAddress address$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GInputMessage.address$VH.get(seg);
    }
    ...
    public static MemoryAddress address$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GInputMessage.address$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress vectors$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GInputMessage.vectors$VH.get(seg);
    }
    ...
    public static MemoryAddress vectors$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GInputMessage.vectors$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress control_messages$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GInputMessage.control_messages$VH.get(seg);
    }
    ...
    public static MemoryAddress control_messages$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GInputMessage.control_messages$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress num_control_messages$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GInputMessage.num_control_messages$VH.get(seg);
    }
    ...
    public static MemoryAddress num_control_messages$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GInputMessage.num_control_messages$VH.get(seg.asSlice(index*sizeof()));
    }
