...
public class _PangoAttrLanguage {
    ...
    public static MemoryAddress value$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoAttrLanguage.value$VH.get(seg);
    }
    ...
    public static MemoryAddress value$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoAttrLanguage.value$VH.get(seg.asSlice(index*sizeof()));
    }
