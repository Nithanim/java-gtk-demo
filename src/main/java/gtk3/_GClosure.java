...
return (jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1, int _x2, jdk.incubator.foreign.MemoryAddress _x3, jdk.incubator.foreign.MemoryAddress _x4, jdk.incubator.foreign.MemoryAddress _x5) -> {
                try {
                    _GClosure.marshal$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, (jdk.incubator.foreign.Addressable)_x1, _x2, (jdk.incubator.foreign.Addressable)_x3, (jdk.incubator.foreign.Addressable)_x4, (jdk.incubator.foreign.Addressable)_x5);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress marshal$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GClosure.marshal$VH.get(seg);
    }
    ...
    public static MemoryAddress marshal$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GClosure.marshal$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress data$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GClosure.data$VH.get(seg);
    }
    ...
    public static MemoryAddress data$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GClosure.data$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress notifiers$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GClosure.notifiers$VH.get(seg);
    }
    ...
    public static MemoryAddress notifiers$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GClosure.notifiers$VH.get(seg.asSlice(index*sizeof()));
    }
