...
public class _GPrivate {
    ...
    public static MemoryAddress p$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GPrivate.p$VH.get(seg);
    }
    ...
    public static MemoryAddress p$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GPrivate.p$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress notify$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GPrivate.notify$VH.get(seg);
    }
    ...
    public static MemoryAddress notify$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GPrivate.notify$VH.get(seg.asSlice(index*sizeof()));
    }
