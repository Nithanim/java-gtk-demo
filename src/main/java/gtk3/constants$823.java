...
class constants$823 {
    ...
    static final MethodHandle g_subprocess_get_stderr_pipe$MH = RuntimeHelper.downcallHandle(
        ...
        constants$823.g_subprocess_get_stderr_pipe$FUNC, false
    );
    ...
    static final MethodHandle g_subprocess_get_identifier$MH = RuntimeHelper.downcallHandle(
        ...
        constants$823.g_subprocess_get_identifier$FUNC, false
    );
    ...
    static final MethodHandle g_subprocess_send_signal$MH = RuntimeHelper.downcallHandle(
        ...
        constants$823.g_subprocess_send_signal$FUNC, false
    );
    ...
    static final MethodHandle g_subprocess_force_exit$MH = RuntimeHelper.downcallHandle(
        ...
        constants$823.g_subprocess_force_exit$FUNC, false
    );
    ...
    static final MethodHandle g_subprocess_wait$MH = RuntimeHelper.downcallHandle(
        "g_subprocess_wait",
        constants$823.g_subprocess_wait$FUNC, false
    );
    ...
    static final MethodHandle g_subprocess_wait_async$MH = RuntimeHelper.downcallHandle(
        ...
        constants$823.g_subprocess_wait_async$FUNC, false
    );
}
