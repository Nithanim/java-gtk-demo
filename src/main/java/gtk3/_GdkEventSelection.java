...
public class _GdkEventSelection {
    ...
    public static MemoryAddress window$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventSelection.window$VH.get(seg);
    }
    ...
    public static MemoryAddress window$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventSelection.window$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress selection$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventSelection.selection$VH.get(seg);
    }
    ...
    public static MemoryAddress selection$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventSelection.selection$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress target$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventSelection.target$VH.get(seg);
    }
    ...
    public static MemoryAddress target$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventSelection.target$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress property$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventSelection.property$VH.get(seg);
    }
    ...
    public static MemoryAddress property$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventSelection.property$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress requestor$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventSelection.requestor$VH.get(seg);
    }
    ...
    public static MemoryAddress requestor$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventSelection.requestor$VH.get(seg.asSlice(index*sizeof()));
    }
