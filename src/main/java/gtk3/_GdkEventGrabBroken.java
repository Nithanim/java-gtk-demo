...
public class _GdkEventGrabBroken {
    ...
    public static MemoryAddress window$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventGrabBroken.window$VH.get(seg);
    }
    ...
    public static MemoryAddress window$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventGrabBroken.window$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress grab_window$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventGrabBroken.grab_window$VH.get(seg);
    }
    ...
    public static MemoryAddress grab_window$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventGrabBroken.grab_window$VH.get(seg.asSlice(index*sizeof()));
    }
