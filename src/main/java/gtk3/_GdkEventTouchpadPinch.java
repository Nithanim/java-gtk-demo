...
public class _GdkEventTouchpadPinch {
    ...
    public static MemoryAddress window$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventTouchpadPinch.window$VH.get(seg);
    }
    ...
    public static MemoryAddress window$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventTouchpadPinch.window$VH.get(seg.asSlice(index*sizeof()));
    }
