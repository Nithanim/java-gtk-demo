...
class constants$722 {
    ...
    static final MethodHandle g_io_module_load$MH = RuntimeHelper.downcallHandle(
        "g_io_module_load",
        constants$722.g_io_module_load$FUNC, false
    );
    ...
    static final MethodHandle g_io_module_unload$MH = RuntimeHelper.downcallHandle(
        "g_io_module_unload",
        constants$722.g_io_module_unload$FUNC, false
    );
    ...
    static final MethodHandle g_io_module_query$MH = RuntimeHelper.downcallHandle(
        "g_io_module_query",
        constants$722.g_io_module_query$FUNC, false
    );
    ...
    static final MethodHandle g_io_scheduler_push_job$MH = RuntimeHelper.downcallHandle(
        ...
        constants$722.g_io_scheduler_push_job$FUNC, false
    );
    ...
    static final MethodHandle g_io_scheduler_cancel_all_jobs$MH = RuntimeHelper.downcallHandle(
        ...
        constants$722.g_io_scheduler_cancel_all_jobs$FUNC, false
    );
    ...
    static final MethodHandle g_io_scheduler_job_send_to_mainloop$MH = RuntimeHelper.downcallHandle(
        ...
        constants$722.g_io_scheduler_job_send_to_mainloop$FUNC, false
    );
}
