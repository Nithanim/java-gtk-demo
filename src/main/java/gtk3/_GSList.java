...
public class _GSList {
    ...
    public static MemoryAddress data$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GSList.data$VH.get(seg);
    }
    ...
    public static MemoryAddress data$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GSList.data$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress next$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GSList.next$VH.get(seg);
    }
    ...
    public static MemoryAddress next$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GSList.next$VH.get(seg.asSlice(index*sizeof()));
    }
