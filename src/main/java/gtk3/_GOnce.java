...
public class _GOnce {
    ...
    public static MemoryAddress retval$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GOnce.retval$VH.get(seg);
    }
    ...
    public static MemoryAddress retval$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GOnce.retval$VH.get(seg.asSlice(index*sizeof()));
    }
