...
return (jdk.incubator.foreign.MemoryAddress _x0, int _x1, jdk.incubator.foreign.MemoryAddress _x2, jdk.incubator.foreign.MemoryAddress _x3) -> {
                try {
                    _GSocketClientClass.event$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, _x1, (jdk.incubator.foreign.Addressable)_x2, (jdk.incubator.foreign.Addressable)_x3);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress event$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GSocketClientClass.event$VH.get(seg);
    }
    ...
    public static MemoryAddress event$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GSocketClientClass.event$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved1$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GSocketClientClass._g_reserved1$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved1$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GSocketClientClass._g_reserved1$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved2$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GSocketClientClass._g_reserved2$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved2$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GSocketClientClass._g_reserved2$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved3$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GSocketClientClass._g_reserved3$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved3$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GSocketClientClass._g_reserved3$VH.get(seg.asSlice(index*sizeof()));
    }
...
return () -> {
    ...
    public static MemoryAddress _g_reserved4$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GSocketClientClass._g_reserved4$VH.get(seg);
    }
    ...
    public static MemoryAddress _g_reserved4$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GSocketClientClass._g_reserved4$VH.get(seg.asSlice(index*sizeof()));
    }
