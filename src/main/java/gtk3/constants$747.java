...
class constants$747 {
    ...
    static final MethodHandle g_mount_is_shadowed$MH = RuntimeHelper.downcallHandle(
        "g_mount_is_shadowed",
        constants$747.g_mount_is_shadowed$FUNC, false
    );
    ...
    static final MethodHandle g_mount_shadow$MH = RuntimeHelper.downcallHandle(
        "g_mount_shadow",
        constants$747.g_mount_shadow$FUNC, false
    );
    ...
    static final MethodHandle g_mount_unshadow$MH = RuntimeHelper.downcallHandle(
        "g_mount_unshadow",
        constants$747.g_mount_unshadow$FUNC, false
    );
    ...
    static final MethodHandle g_mount_unmount_with_operation$MH = RuntimeHelper.downcallHandle(
        ...
        constants$747.g_mount_unmount_with_operation$FUNC, false
    );
    ...
    static final MethodHandle g_mount_unmount_with_operation_finish$MH = RuntimeHelper.downcallHandle(
        ...
        constants$747.g_mount_unmount_with_operation_finish$FUNC, false
    );
    ...
    static final MethodHandle g_mount_eject_with_operation$MH = RuntimeHelper.downcallHandle(
        ...
        constants$747.g_mount_eject_with_operation$FUNC, false
    );
}
