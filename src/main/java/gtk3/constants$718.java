...
class constants$718 {
    ...
    static final MethodHandle g_module_error$MH = RuntimeHelper.downcallHandle(
        "g_module_error",
        constants$718.g_module_error$FUNC, false
    );
    ...
    static final MethodHandle g_module_symbol$MH = RuntimeHelper.downcallHandle(
        "g_module_symbol",
        constants$718.g_module_symbol$FUNC, false
    );
    ...
    static final MethodHandle g_module_name$MH = RuntimeHelper.downcallHandle(
        "g_module_name",
        constants$718.g_module_name$FUNC, false
    );
    ...
    static final MethodHandle g_module_build_path$MH = RuntimeHelper.downcallHandle(
        "g_module_build_path",
        constants$718.g_module_build_path$FUNC, false
    );
    ...
    static final MethodHandle g_io_module_scope_new$MH = RuntimeHelper.downcallHandle(
        ...
        constants$718.g_io_module_scope_new$FUNC, false
    );
    ...
    static final MethodHandle g_io_module_scope_free$MH = RuntimeHelper.downcallHandle(
        ...
        constants$718.g_io_module_scope_free$FUNC, false
    );
}
