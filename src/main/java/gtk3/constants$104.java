...
class constants$104 {
    ...
    static final MethodHandle g_date_valid_month$MH = RuntimeHelper.downcallHandle(
        "g_date_valid_month",
        constants$104.g_date_valid_month$FUNC, false
    );
    ...
    static final MethodHandle g_date_valid_year$MH = RuntimeHelper.downcallHandle(
        "g_date_valid_year",
        constants$104.g_date_valid_year$FUNC, false
    );
    ...
    static final MethodHandle g_date_valid_weekday$MH = RuntimeHelper.downcallHandle(
        ...
        constants$104.g_date_valid_weekday$FUNC, false
    );
    ...
    static final MethodHandle g_date_valid_julian$MH = RuntimeHelper.downcallHandle(
        "g_date_valid_julian",
        constants$104.g_date_valid_julian$FUNC, false
    );
    ...
    static final MethodHandle g_date_valid_dmy$MH = RuntimeHelper.downcallHandle(
        "g_date_valid_dmy",
        constants$104.g_date_valid_dmy$FUNC, false
    );
    ...
    static final MethodHandle g_date_get_weekday$MH = RuntimeHelper.downcallHandle(
        "g_date_get_weekday",
        constants$104.g_date_get_weekday$FUNC, false
    );
}
