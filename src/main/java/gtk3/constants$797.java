...
class constants$797 {
    ...
    static final MethodHandle g_simple_async_report_gerror_in_idle$MH = RuntimeHelper.downcallHandle(
        ...
        constants$797.g_simple_async_report_gerror_in_idle$FUNC, false
    );
    ...
    static final MethodHandle g_simple_async_report_take_gerror_in_idle$MH = RuntimeHelper.downcallHandle(
        ...
        constants$797.g_simple_async_report_take_gerror_in_idle$FUNC, false
    );
    ...
    static final MethodHandle g_simple_io_stream_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$797.g_simple_io_stream_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_simple_io_stream_new$MH = RuntimeHelper.downcallHandle(
        ...
        constants$797.g_simple_io_stream_new$FUNC, false
    );
    ...
    static final MethodHandle g_simple_permission_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$797.g_simple_permission_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_simple_permission_new$MH = RuntimeHelper.downcallHandle(
        ...
        constants$797.g_simple_permission_new$FUNC, false
    );
}
