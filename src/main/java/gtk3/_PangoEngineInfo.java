...
public class _PangoEngineInfo {
    ...
    public static MemoryAddress id$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoEngineInfo.id$VH.get(seg);
    }
    ...
    public static MemoryAddress id$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoEngineInfo.id$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress engine_type$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoEngineInfo.engine_type$VH.get(seg);
    }
    ...
    public static MemoryAddress engine_type$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoEngineInfo.engine_type$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress render_type$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoEngineInfo.render_type$VH.get(seg);
    }
    ...
    public static MemoryAddress render_type$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoEngineInfo.render_type$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress scripts$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoEngineInfo.scripts$VH.get(seg);
    }
    ...
    public static MemoryAddress scripts$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoEngineInfo.scripts$VH.get(seg.asSlice(index*sizeof()));
    }
