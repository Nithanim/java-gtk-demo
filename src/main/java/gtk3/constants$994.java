...
class constants$994 {
    ...
    static final MethodHandle hb_font_get_nominal_glyphs_func_t$MH = RuntimeHelper.downcallHandle(
        constants$994.hb_font_get_nominal_glyphs_func_t$FUNC, false
    );
    ...
    static final MethodHandle hb_font_get_glyph_advance_func_t$MH = RuntimeHelper.downcallHandle(
        constants$994.hb_font_get_glyph_advance_func_t$FUNC, false
    );
    ...
    static final MethodHandle hb_font_get_glyph_h_advance_func_t$MH = RuntimeHelper.downcallHandle(
        constants$994.hb_font_get_glyph_h_advance_func_t$FUNC, false
    );
}
