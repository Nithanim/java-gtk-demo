...
public class _AtkPlugClass {
    ...
    static final MethodHandle get_object_id$MH = RuntimeHelper.downcallHandle(
        _AtkPlugClass.get_object_id$FUNC, false
    );
    public interface get_object_id {

        jdk.incubator.foreign.Addressable apply(jdk.incubator.foreign.MemoryAddress _x0);
        static NativeSymbol allocate(get_object_id fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(get_object_id.class, fi, _AtkPlugClass.get_object_id$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;)Ljdk/incubator/foreign/Addressable;", scope);
        }
        static get_object_id ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("get_object_id::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return (jdk.incubator.foreign.MemoryAddress _x0) -> {
                try {
                    return (jdk.incubator.foreign.Addressable)(jdk.incubator.foreign.MemoryAddress)_AtkPlugClass.get_object_id$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress get_object_id$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkPlugClass.get_object_id$VH.get(seg);
    }
    ...
    public static MemoryAddress get_object_id$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkPlugClass.get_object_id$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static get_object_id get_object_id (MemorySegment segment, ResourceScope scope) {
