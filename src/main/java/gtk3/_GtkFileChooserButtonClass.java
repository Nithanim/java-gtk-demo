...
public class _GtkFileChooserButtonClass {
    ...
    static final MethodHandle file_set$MH = RuntimeHelper.downcallHandle(
        _GtkFileChooserButtonClass.file_set$FUNC, false
    );
    public interface file_set {

        void apply(jdk.incubator.foreign.MemoryAddress _x0);
        static NativeSymbol allocate(file_set fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(file_set.class, fi, _GtkFileChooserButtonClass.file_set$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;)V", scope);
        }
        static file_set ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("file_set::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return (jdk.incubator.foreign.MemoryAddress _x0) -> {
                try {
                    _GtkFileChooserButtonClass.file_set$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress file_set$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkFileChooserButtonClass.file_set$VH.get(seg);
    }
    ...
    public static MemoryAddress file_set$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkFileChooserButtonClass.file_set$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static file_set file_set (MemorySegment segment, ResourceScope scope) {
    ...
    static final MethodHandle __gtk_reserved1$MH = RuntimeHelper.downcallHandle(
        _GtkFileChooserButtonClass.__gtk_reserved1$FUNC, false
    );
    public interface __gtk_reserved1 {

        void apply();
        static NativeSymbol allocate(__gtk_reserved1 fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(__gtk_reserved1.class, fi, _GtkFileChooserButtonClass.__gtk_reserved1$FUNC, "()V", scope);
        }
...
return () -> {
                try {
                    _GtkFileChooserButtonClass.__gtk_reserved1$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress __gtk_reserved1$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkFileChooserButtonClass.__gtk_reserved1$VH.get(seg);
    }
    ...
    public static MemoryAddress __gtk_reserved1$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkFileChooserButtonClass.__gtk_reserved1$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final MethodHandle __gtk_reserved2$MH = RuntimeHelper.downcallHandle(
        _GtkFileChooserButtonClass.__gtk_reserved2$FUNC, false
    );
    public interface __gtk_reserved2 {

        void apply();
        static NativeSymbol allocate(__gtk_reserved2 fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(__gtk_reserved2.class, fi, _GtkFileChooserButtonClass.__gtk_reserved2$FUNC, "()V", scope);
        }
...
return () -> {
                try {
                    _GtkFileChooserButtonClass.__gtk_reserved2$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress __gtk_reserved2$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkFileChooserButtonClass.__gtk_reserved2$VH.get(seg);
    }
    ...
    public static MemoryAddress __gtk_reserved2$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkFileChooserButtonClass.__gtk_reserved2$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final MethodHandle __gtk_reserved3$MH = RuntimeHelper.downcallHandle(
        _GtkFileChooserButtonClass.__gtk_reserved3$FUNC, false
    );
    public interface __gtk_reserved3 {

        void apply();
        static NativeSymbol allocate(__gtk_reserved3 fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(__gtk_reserved3.class, fi, _GtkFileChooserButtonClass.__gtk_reserved3$FUNC, "()V", scope);
        }
...
return () -> {
                try {
                    _GtkFileChooserButtonClass.__gtk_reserved3$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress __gtk_reserved3$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkFileChooserButtonClass.__gtk_reserved3$VH.get(seg);
    }
    ...
    public static MemoryAddress __gtk_reserved3$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkFileChooserButtonClass.__gtk_reserved3$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final MethodHandle __gtk_reserved4$MH = RuntimeHelper.downcallHandle(
        _GtkFileChooserButtonClass.__gtk_reserved4$FUNC, false
    );
    public interface __gtk_reserved4 {

        void apply();
        static NativeSymbol allocate(__gtk_reserved4 fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(__gtk_reserved4.class, fi, _GtkFileChooserButtonClass.__gtk_reserved4$FUNC, "()V", scope);
        }
...
return () -> {
                try {
                    _GtkFileChooserButtonClass.__gtk_reserved4$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress __gtk_reserved4$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkFileChooserButtonClass.__gtk_reserved4$VH.get(seg);
    }
    ...
    public static MemoryAddress __gtk_reserved4$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkFileChooserButtonClass.__gtk_reserved4$VH.get(seg.asSlice(index*sizeof()));
    }
