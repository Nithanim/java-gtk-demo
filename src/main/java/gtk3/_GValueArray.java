...
public class _GValueArray {
    ...
    public static MemoryAddress values$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GValueArray.values$VH.get(seg);
    }
    ...
    public static MemoryAddress values$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GValueArray.values$VH.get(seg.asSlice(index*sizeof()));
    }
