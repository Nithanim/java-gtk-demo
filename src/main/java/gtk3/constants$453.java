...
class constants$453 {
    ...
    static final MethodHandle g_signal_query$MH = RuntimeHelper.downcallHandle(
        "g_signal_query",
        constants$453.g_signal_query$FUNC, false
    );
    ...
    static final MethodHandle g_signal_list_ids$MH = RuntimeHelper.downcallHandle(
        "g_signal_list_ids",
        constants$453.g_signal_list_ids$FUNC, false
    );
    ...
    static final MethodHandle g_signal_is_valid_name$MH = RuntimeHelper.downcallHandle(
        ...
        constants$453.g_signal_is_valid_name$FUNC, false
    );
    ...
    static final MethodHandle g_signal_parse_name$MH = RuntimeHelper.downcallHandle(
        "g_signal_parse_name",
        constants$453.g_signal_parse_name$FUNC, false
    );
    ...
    static final MethodHandle g_signal_get_invocation_hint$MH = RuntimeHelper.downcallHandle(
        ...
        constants$453.g_signal_get_invocation_hint$FUNC, false
    );
    ...
    static final MethodHandle g_signal_stop_emission$MH = RuntimeHelper.downcallHandle(
        ...
        constants$453.g_signal_stop_emission$FUNC, false
    );
}
