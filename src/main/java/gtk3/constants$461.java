...
class constants$461 {
    ...
    static final MethodHandle g_key_file_get_type$MH = RuntimeHelper.downcallHandle(
        "g_key_file_get_type",
        constants$461.g_key_file_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_main_loop_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$461.g_main_loop_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_main_context_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$461.g_main_context_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_source_get_type$MH = RuntimeHelper.downcallHandle(
        "g_source_get_type",
        constants$461.g_source_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_pollfd_get_type$MH = RuntimeHelper.downcallHandle(
        "g_pollfd_get_type",
        constants$461.g_pollfd_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_thread_get_type$MH = RuntimeHelper.downcallHandle(
        "g_thread_get_type",
        constants$461.g_thread_get_type$FUNC, false
    );
}
