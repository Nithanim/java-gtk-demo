...
class constants$713 {
    ...
    static final MethodHandle g_tls_authentication_mode_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$713.g_tls_authentication_mode_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_tls_channel_binding_type_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$713.g_tls_channel_binding_type_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_tls_channel_binding_error_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$713.g_tls_channel_binding_error_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_tls_rehandshake_mode_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$713.g_tls_rehandshake_mode_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_tls_password_flags_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$713.g_tls_password_flags_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_tls_interaction_result_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$713.g_tls_interaction_result_get_type$FUNC, false
    );
}
