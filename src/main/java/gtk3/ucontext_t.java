...
public class ucontext_t {
    ...
    public static MemoryAddress uc_link$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)ucontext_t.uc_link$VH.get(seg);
    }
    ...
    public static MemoryAddress uc_link$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)ucontext_t.uc_link$VH.get(seg.asSlice(index*sizeof()));
    }
