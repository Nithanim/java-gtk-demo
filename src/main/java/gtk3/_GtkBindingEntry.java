...
public class _GtkBindingEntry {
    ...
    public static MemoryAddress binding_set$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkBindingEntry.binding_set$VH.get(seg);
    }
    ...
    public static MemoryAddress binding_set$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkBindingEntry.binding_set$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress set_next$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkBindingEntry.set_next$VH.get(seg);
    }
    ...
    public static MemoryAddress set_next$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkBindingEntry.set_next$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress hash_next$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkBindingEntry.hash_next$VH.get(seg);
    }
    ...
    public static MemoryAddress hash_next$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkBindingEntry.hash_next$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress signals$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkBindingEntry.signals$VH.get(seg);
    }
    ...
    public static MemoryAddress signals$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkBindingEntry.signals$VH.get(seg.asSlice(index*sizeof()));
    }
