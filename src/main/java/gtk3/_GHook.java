...
public class _GHook {
    ...
    public static MemoryAddress data$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GHook.data$VH.get(seg);
    }
    ...
    public static MemoryAddress data$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GHook.data$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress next$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GHook.next$VH.get(seg);
    }
    ...
    public static MemoryAddress next$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GHook.next$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress prev$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GHook.prev$VH.get(seg);
    }
    ...
    public static MemoryAddress prev$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GHook.prev$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress func$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GHook.func$VH.get(seg);
    }
    ...
    public static MemoryAddress func$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GHook.func$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress destroy$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GHook.destroy$VH.get(seg);
    }
    ...
    public static MemoryAddress destroy$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GHook.destroy$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static GDestroyNotify destroy (MemorySegment segment, ResourceScope scope) {
