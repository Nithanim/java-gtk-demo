...
public class _GtkIMContextInfo {
    ...
    public static MemoryAddress context_id$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkIMContextInfo.context_id$VH.get(seg);
    }
    ...
    public static MemoryAddress context_id$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkIMContextInfo.context_id$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress context_name$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkIMContextInfo.context_name$VH.get(seg);
    }
    ...
    public static MemoryAddress context_name$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkIMContextInfo.context_name$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress domain$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkIMContextInfo.domain$VH.get(seg);
    }
    ...
    public static MemoryAddress domain$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkIMContextInfo.domain$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress domain_dirname$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkIMContextInfo.domain_dirname$VH.get(seg);
    }
    ...
    public static MemoryAddress domain_dirname$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkIMContextInfo.domain_dirname$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress default_locales$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkIMContextInfo.default_locales$VH.get(seg);
    }
    ...
    public static MemoryAddress default_locales$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkIMContextInfo.default_locales$VH.get(seg.asSlice(index*sizeof()));
    }
