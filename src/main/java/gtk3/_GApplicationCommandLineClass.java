...
return (jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1) -> {
                try {
                    _GApplicationCommandLineClass.print_literal$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, (jdk.incubator.foreign.Addressable)_x1);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress print_literal$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GApplicationCommandLineClass.print_literal$VH.get(seg);
    }
    ...
    public static MemoryAddress print_literal$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GApplicationCommandLineClass.print_literal$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1) -> {
                try {
                    _GApplicationCommandLineClass.printerr_literal$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, (jdk.incubator.foreign.Addressable)_x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress printerr_literal$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GApplicationCommandLineClass.printerr_literal$VH.get(seg);
    }
    ...
    public static MemoryAddress printerr_literal$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GApplicationCommandLineClass.printerr_literal$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (jdk.incubator.foreign.MemoryAddress _x0) -> {
                try {
                    return (jdk.incubator.foreign.Addressable)(jdk.incubator.foreign.MemoryAddress)_GApplicationCommandLineClass.get_stdin$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress get_stdin$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GApplicationCommandLineClass.get_stdin$VH.get(seg);
    }
    ...
    public static MemoryAddress get_stdin$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GApplicationCommandLineClass.get_stdin$VH.get(seg.asSlice(index*sizeof()));
    }
