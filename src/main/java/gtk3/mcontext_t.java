...
public class mcontext_t {
    ...
    public static MemoryAddress fpregs$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)mcontext_t.fpregs$VH.get(seg);
    }
    ...
    public static MemoryAddress fpregs$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)mcontext_t.fpregs$VH.get(seg.asSlice(index*sizeof()));
    }
