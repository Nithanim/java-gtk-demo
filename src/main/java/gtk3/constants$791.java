...
class constants$791 {
    ...
    static final MethodHandle g_simple_action_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$791.g_simple_action_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_simple_action_new$MH = RuntimeHelper.downcallHandle(
        "g_simple_action_new",
        constants$791.g_simple_action_new$FUNC, false
    );
    ...
    static final MethodHandle g_simple_action_new_stateful$MH = RuntimeHelper.downcallHandle(
        ...
        constants$791.g_simple_action_new_stateful$FUNC, false
    );
    ...
    static final MethodHandle g_simple_action_set_enabled$MH = RuntimeHelper.downcallHandle(
        ...
        constants$791.g_simple_action_set_enabled$FUNC, false
    );
    ...
    static final MethodHandle g_simple_action_set_state$MH = RuntimeHelper.downcallHandle(
        ...
        constants$791.g_simple_action_set_state$FUNC, false
    );
    ...
    static final MethodHandle g_simple_action_set_state_hint$MH = RuntimeHelper.downcallHandle(
        ...
        constants$791.g_simple_action_set_state_hint$FUNC, false
    );
}
