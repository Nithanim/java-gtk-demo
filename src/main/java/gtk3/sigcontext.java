...
public class sigcontext {
    ...
    public static MemoryAddress fpstate$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)sigcontext.fpstate$VH.get(seg);
    }
    ...
    public static MemoryAddress fpstate$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)sigcontext.fpstate$VH.get(seg.asSlice(index*sizeof()));
    }
