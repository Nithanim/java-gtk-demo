...
class constants$92 {
    ...
    static final MethodHandle g_bytes_new_from_bytes$MH = RuntimeHelper.downcallHandle(
        ...
        constants$92.g_bytes_new_from_bytes$FUNC, false
    );
    ...
    static final MethodHandle g_bytes_get_data$MH = RuntimeHelper.downcallHandle(
        "g_bytes_get_data",
        constants$92.g_bytes_get_data$FUNC, false
    );
    ...
    static final MethodHandle g_bytes_get_size$MH = RuntimeHelper.downcallHandle(
        "g_bytes_get_size",
        constants$92.g_bytes_get_size$FUNC, false
    );
    ...
    static final MethodHandle g_bytes_ref$MH = RuntimeHelper.downcallHandle(
        "g_bytes_ref",
        constants$92.g_bytes_ref$FUNC, false
    );
    ...
    static final MethodHandle g_bytes_unref$MH = RuntimeHelper.downcallHandle(
        "g_bytes_unref",
        constants$92.g_bytes_unref$FUNC, false
    );
    ...
    static final MethodHandle g_bytes_unref_to_data$MH = RuntimeHelper.downcallHandle(
        ...
        constants$92.g_bytes_unref_to_data$FUNC, false
    );
}
