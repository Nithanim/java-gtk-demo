...
class constants$695 {
    ...
    static final MethodHandle g_filename_completer_get_completion_suffix$MH = RuntimeHelper.downcallHandle(
        ...
        constants$695.g_filename_completer_get_completion_suffix$FUNC, false
    );
    ...
    static final MethodHandle g_filename_completer_get_completions$MH = RuntimeHelper.downcallHandle(
        ...
        constants$695.g_filename_completer_get_completions$FUNC, false
    );
    ...
    static final MethodHandle g_filename_completer_set_dirs_only$MH = RuntimeHelper.downcallHandle(
        ...
        constants$695.g_filename_completer_set_dirs_only$FUNC, false
    );
    ...
    static final MethodHandle g_file_output_stream_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$695.g_file_output_stream_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_file_output_stream_query_info$MH = RuntimeHelper.downcallHandle(
        ...
        constants$695.g_file_output_stream_query_info$FUNC, false
    );
    ...
    static final MethodHandle g_file_output_stream_query_info_async$MH = RuntimeHelper.downcallHandle(
        ...
        constants$695.g_file_output_stream_query_info_async$FUNC, false
    );
}
