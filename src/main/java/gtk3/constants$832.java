...
class constants$832 {
    ...
    static final MethodHandle g_task_get_cancellable$MH = RuntimeHelper.downcallHandle(
        ...
        constants$832.g_task_get_cancellable$FUNC, false
    );
    ...
    static final MethodHandle g_task_get_check_cancellable$MH = RuntimeHelper.downcallHandle(
        ...
        constants$832.g_task_get_check_cancellable$FUNC, false
    );
    ...
    static final MethodHandle g_task_get_source_tag$MH = RuntimeHelper.downcallHandle(
        ...
        constants$832.g_task_get_source_tag$FUNC, false
    );
    ...
    static final MethodHandle g_task_get_name$MH = RuntimeHelper.downcallHandle(
        "g_task_get_name",
        constants$832.g_task_get_name$FUNC, false
    );
    ...
    static final MethodHandle g_task_is_valid$MH = RuntimeHelper.downcallHandle(
        "g_task_is_valid",
        constants$832.g_task_is_valid$FUNC, false
    );
