...
public class _GtkToolItemClass {
    ...
    static final MethodHandle create_menu_proxy$MH = RuntimeHelper.downcallHandle(
        _GtkToolItemClass.create_menu_proxy$FUNC, false
    );
    public interface create_menu_proxy {

        int apply(jdk.incubator.foreign.MemoryAddress _x0);
        static NativeSymbol allocate(create_menu_proxy fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(create_menu_proxy.class, fi, _GtkToolItemClass.create_menu_proxy$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;)I", scope);
        }
        static create_menu_proxy ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("create_menu_proxy::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return (jdk.incubator.foreign.MemoryAddress _x0) -> {
                try {
                    return (int)_GtkToolItemClass.create_menu_proxy$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress create_menu_proxy$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkToolItemClass.create_menu_proxy$VH.get(seg);
    }
    ...
    public static MemoryAddress create_menu_proxy$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkToolItemClass.create_menu_proxy$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static create_menu_proxy create_menu_proxy (MemorySegment segment, ResourceScope scope) {
    ...
    static final MethodHandle toolbar_reconfigured$MH = RuntimeHelper.downcallHandle(
        _GtkToolItemClass.toolbar_reconfigured$FUNC, false
    );
    public interface toolbar_reconfigured {

        void apply(jdk.incubator.foreign.MemoryAddress _x0);
        static NativeSymbol allocate(toolbar_reconfigured fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(toolbar_reconfigured.class, fi, _GtkToolItemClass.toolbar_reconfigured$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;)V", scope);
        }
        static toolbar_reconfigured ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("toolbar_reconfigured::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return (jdk.incubator.foreign.MemoryAddress _x0) -> {
                try {
                    _GtkToolItemClass.toolbar_reconfigured$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress toolbar_reconfigured$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkToolItemClass.toolbar_reconfigured$VH.get(seg);
    }
    ...
    public static MemoryAddress toolbar_reconfigured$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkToolItemClass.toolbar_reconfigured$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static toolbar_reconfigured toolbar_reconfigured (MemorySegment segment, ResourceScope scope) {
    ...
    static final MethodHandle _gtk_reserved1$MH = RuntimeHelper.downcallHandle(
        _GtkToolItemClass._gtk_reserved1$FUNC, false
    );
    public interface _gtk_reserved1 {

        void apply();
        static NativeSymbol allocate(_gtk_reserved1 fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(_gtk_reserved1.class, fi, _GtkToolItemClass._gtk_reserved1$FUNC, "()V", scope);
        }
...
return () -> {
                try {
                    _GtkToolItemClass._gtk_reserved1$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress _gtk_reserved1$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkToolItemClass._gtk_reserved1$VH.get(seg);
    }
    ...
    public static MemoryAddress _gtk_reserved1$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkToolItemClass._gtk_reserved1$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final MethodHandle _gtk_reserved2$MH = RuntimeHelper.downcallHandle(
        _GtkToolItemClass._gtk_reserved2$FUNC, false
    );
    public interface _gtk_reserved2 {

        void apply();
        static NativeSymbol allocate(_gtk_reserved2 fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(_gtk_reserved2.class, fi, _GtkToolItemClass._gtk_reserved2$FUNC, "()V", scope);
        }
...
return () -> {
                try {
                    _GtkToolItemClass._gtk_reserved2$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress _gtk_reserved2$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkToolItemClass._gtk_reserved2$VH.get(seg);
    }
    ...
    public static MemoryAddress _gtk_reserved2$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkToolItemClass._gtk_reserved2$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final MethodHandle _gtk_reserved3$MH = RuntimeHelper.downcallHandle(
        _GtkToolItemClass._gtk_reserved3$FUNC, false
    );
    public interface _gtk_reserved3 {

        void apply();
        static NativeSymbol allocate(_gtk_reserved3 fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(_gtk_reserved3.class, fi, _GtkToolItemClass._gtk_reserved3$FUNC, "()V", scope);
        }
...
return () -> {
                try {
                    _GtkToolItemClass._gtk_reserved3$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress _gtk_reserved3$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkToolItemClass._gtk_reserved3$VH.get(seg);
    }
    ...
    public static MemoryAddress _gtk_reserved3$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkToolItemClass._gtk_reserved3$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final MethodHandle _gtk_reserved4$MH = RuntimeHelper.downcallHandle(
        _GtkToolItemClass._gtk_reserved4$FUNC, false
    );
    public interface _gtk_reserved4 {

        void apply();
        static NativeSymbol allocate(_gtk_reserved4 fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(_gtk_reserved4.class, fi, _GtkToolItemClass._gtk_reserved4$FUNC, "()V", scope);
        }
...
return () -> {
                try {
                    _GtkToolItemClass._gtk_reserved4$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress _gtk_reserved4$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkToolItemClass._gtk_reserved4$VH.get(seg);
    }
    ...
    public static MemoryAddress _gtk_reserved4$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkToolItemClass._gtk_reserved4$VH.get(seg.asSlice(index*sizeof()));
    }
