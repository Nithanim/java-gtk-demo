...
public class stack_t {
    ...
    public static MemoryAddress ss_sp$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)stack_t.ss_sp$VH.get(seg);
    }
    ...
    public static MemoryAddress ss_sp$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)stack_t.ss_sp$VH.get(seg.asSlice(index*sizeof()));
    }
