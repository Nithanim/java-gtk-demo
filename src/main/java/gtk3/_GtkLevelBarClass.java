...
public class _GtkLevelBarClass {
    ...
    static final MethodHandle offset_changed$MH = RuntimeHelper.downcallHandle(
        _GtkLevelBarClass.offset_changed$FUNC, false
    );
    public interface offset_changed {
        ...
        static NativeSymbol allocate(offset_changed fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(offset_changed.class, fi, _GtkLevelBarClass.offset_changed$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;)V", scope);
        }
        static offset_changed ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("offset_changed::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return (jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1) -> {
                try {
                    _GtkLevelBarClass.offset_changed$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, (jdk.incubator.foreign.Addressable)_x1);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress offset_changed$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkLevelBarClass.offset_changed$VH.get(seg);
    }
    ...
    public static MemoryAddress offset_changed$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkLevelBarClass.offset_changed$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static offset_changed offset_changed (MemorySegment segment, ResourceScope scope) {
