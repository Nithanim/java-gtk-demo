...
class constants$190 {
    ...
    static final MethodHandle g_string_append_uri_escaped$MH = RuntimeHelper.downcallHandle(
        ...
        constants$190.g_string_append_uri_escaped$FUNC, false
    );
    ...
    static final MethodHandle g_string_append_c_inline$MH = RuntimeHelper.downcallHandle(
        ...
        constants$190.g_string_append_c_inline$FUNC, false
    );
    ...
    static final MethodHandle g_string_down$MH = RuntimeHelper.downcallHandle(
        "g_string_down",
        constants$190.g_string_down$FUNC, false
    );
    ...
    static final MethodHandle g_string_up$MH = RuntimeHelper.downcallHandle(
        "g_string_up",
        constants$190.g_string_up$FUNC, false
    );
    ...
    static final MethodHandle GIOFunc$MH = RuntimeHelper.downcallHandle(
        constants$190.GIOFunc$FUNC, false
    );
}
