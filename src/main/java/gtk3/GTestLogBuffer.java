...
public class GTestLogBuffer {
    ...
    public static MemoryAddress data$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)GTestLogBuffer.data$VH.get(seg);
    }
    ...
    public static MemoryAddress data$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)GTestLogBuffer.data$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress msgs$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)GTestLogBuffer.msgs$VH.get(seg);
    }
    ...
    public static MemoryAddress msgs$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)GTestLogBuffer.msgs$VH.get(seg.asSlice(index*sizeof()));
    }
