...
return (jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1, jdk.incubator.foreign.MemoryAddress _x2, jdk.incubator.foreign.MemoryAddress _x3) -> {
                try {
                    _GRemoteActionGroupInterface.activate_action_full$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, (jdk.incubator.foreign.Addressable)_x1, (jdk.incubator.foreign.Addressable)_x2, (jdk.incubator.foreign.Addressable)_x3);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress activate_action_full$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GRemoteActionGroupInterface.activate_action_full$VH.get(seg);
    }
    ...
    public static MemoryAddress activate_action_full$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GRemoteActionGroupInterface.activate_action_full$VH.get(seg.asSlice(index*sizeof()));
    }
...
return (jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1, jdk.incubator.foreign.MemoryAddress _x2, jdk.incubator.foreign.MemoryAddress _x3) -> {
                try {
                    _GRemoteActionGroupInterface.change_action_state_full$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, (jdk.incubator.foreign.Addressable)_x1, (jdk.incubator.foreign.Addressable)_x2, (jdk.incubator.foreign.Addressable)_x3);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress change_action_state_full$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GRemoteActionGroupInterface.change_action_state_full$VH.get(seg);
    }
    ...
    public static MemoryAddress change_action_state_full$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GRemoteActionGroupInterface.change_action_state_full$VH.get(seg.asSlice(index*sizeof()));
    }
