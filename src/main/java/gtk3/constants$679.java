...
class constants$679 {
    ...
    static final MethodHandle g_file_info_get_attribute_status$MH = RuntimeHelper.downcallHandle(
        ...
        constants$679.g_file_info_get_attribute_status$FUNC, false
    );
    ...
    static final MethodHandle g_file_info_set_attribute_status$MH = RuntimeHelper.downcallHandle(
        ...
        constants$679.g_file_info_set_attribute_status$FUNC, false
    );
    ...
    static final MethodHandle g_file_info_get_attribute_as_string$MH = RuntimeHelper.downcallHandle(
        ...
        constants$679.g_file_info_get_attribute_as_string$FUNC, false
    );
    ...
    static final MethodHandle g_file_info_get_attribute_string$MH = RuntimeHelper.downcallHandle(
        ...
        constants$679.g_file_info_get_attribute_string$FUNC, false
    );
    ...
    static final MethodHandle g_file_info_get_attribute_byte_string$MH = RuntimeHelper.downcallHandle(
        ...
        constants$679.g_file_info_get_attribute_byte_string$FUNC, false
    );
    ...
    static final MethodHandle g_file_info_get_attribute_boolean$MH = RuntimeHelper.downcallHandle(
        ...
        constants$679.g_file_info_get_attribute_boolean$FUNC, false
    );
}
