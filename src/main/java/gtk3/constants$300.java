...
class constants$300 {
    ...
    static final MethodHandle g_strndup$MH = RuntimeHelper.downcallHandle(
        "g_strndup",
        constants$300.g_strndup$FUNC, false
    );
    ...
    static final MethodHandle g_strnfill$MH = RuntimeHelper.downcallHandle(
        "g_strnfill",
        constants$300.g_strnfill$FUNC, false
    );
    ...
    static final MethodHandle g_strconcat$MH = RuntimeHelper.downcallHandle(
        "g_strconcat",
        constants$300.g_strconcat$FUNC, true
    );
    ...
    static final MethodHandle g_strjoin$MH = RuntimeHelper.downcallHandle(
        "g_strjoin",
        constants$300.g_strjoin$FUNC, true
    );
    ...
    static final MethodHandle g_strcompress$MH = RuntimeHelper.downcallHandle(
        "g_strcompress",
        constants$300.g_strcompress$FUNC, false
    );
    ...
    static final MethodHandle g_strescape$MH = RuntimeHelper.downcallHandle(
        "g_strescape",
        constants$300.g_strescape$FUNC, false
    );
}
