...
public class _GQueue {
    ...
    public static MemoryAddress head$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GQueue.head$VH.get(seg);
    }
    ...
    public static MemoryAddress head$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GQueue.head$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress tail$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GQueue.tail$VH.get(seg);
    }
    ...
    public static MemoryAddress tail$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GQueue.tail$VH.get(seg.asSlice(index*sizeof()));
    }
