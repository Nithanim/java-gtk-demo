    ...
    public static class _sifields {
        ...
        public static class _sigfault {
            ...
            public static MemoryAddress si_addr$get(MemorySegment seg) {
                return (jdk.incubator.foreign.MemoryAddress)_sigfault.si_addr$VH.get(seg);
            }
            ...
            public static MemoryAddress si_addr$get(MemorySegment seg, long index) {
                return (jdk.incubator.foreign.MemoryAddress)_sigfault.si_addr$VH.get(seg.asSlice(index*sizeof()));
            }
            ...
            public static class _bounds {
                ...
                public static class _addr_bnd {
                    ...
                    public static MemoryAddress _lower$get(MemorySegment seg) {
                        return (jdk.incubator.foreign.MemoryAddress)_addr_bnd._lower$VH.get(seg);
                    }
                    ...
                    public static MemoryAddress _lower$get(MemorySegment seg, long index) {
                        return (jdk.incubator.foreign.MemoryAddress)_addr_bnd._lower$VH.get(seg.asSlice(index*sizeof()));
                    }
                    ...
                    public static MemoryAddress _upper$get(MemorySegment seg) {
                        return (jdk.incubator.foreign.MemoryAddress)_addr_bnd._upper$VH.get(seg);
                    }
                    ...
                    public static MemoryAddress _upper$get(MemorySegment seg, long index) {
                        return (jdk.incubator.foreign.MemoryAddress)_addr_bnd._upper$VH.get(seg.asSlice(index*sizeof()));
                    }
        ...
        public static class _sigsys {
            ...
            public static MemoryAddress _call_addr$get(MemorySegment seg) {
                return (jdk.incubator.foreign.MemoryAddress)_sigsys._call_addr$VH.get(seg);
            }
            ...
            public static MemoryAddress _call_addr$get(MemorySegment seg, long index) {
                return (jdk.incubator.foreign.MemoryAddress)_sigsys._call_addr$VH.get(seg.asSlice(index*sizeof()));
            }
