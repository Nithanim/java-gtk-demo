...
public class _GDBusNodeInfo {
    ...
    public static MemoryAddress path$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusNodeInfo.path$VH.get(seg);
    }
    ...
    public static MemoryAddress path$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusNodeInfo.path$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress interfaces$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusNodeInfo.interfaces$VH.get(seg);
    }
    ...
    public static MemoryAddress interfaces$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusNodeInfo.interfaces$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress nodes$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusNodeInfo.nodes$VH.get(seg);
    }
    ...
    public static MemoryAddress nodes$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusNodeInfo.nodes$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress annotations$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusNodeInfo.annotations$VH.get(seg);
    }
    ...
    public static MemoryAddress annotations$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GDBusNodeInfo.annotations$VH.get(seg.asSlice(index*sizeof()));
    }
