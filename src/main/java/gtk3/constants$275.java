...
class constants$275 {
    ...
    static final MethodHandle g_sequence_free$MH = RuntimeHelper.downcallHandle(
        "g_sequence_free",
        constants$275.g_sequence_free$FUNC, false
    );
    ...
    static final MethodHandle g_sequence_get_length$MH = RuntimeHelper.downcallHandle(
        ...
        constants$275.g_sequence_get_length$FUNC, false
    );
    ...
    static final MethodHandle g_sequence_foreach$MH = RuntimeHelper.downcallHandle(
        "g_sequence_foreach",
        constants$275.g_sequence_foreach$FUNC, false
    );
    ...
    static final MethodHandle g_sequence_foreach_range$MH = RuntimeHelper.downcallHandle(
        ...
        constants$275.g_sequence_foreach_range$FUNC, false
    );
    ...
    static final MethodHandle g_sequence_sort$MH = RuntimeHelper.downcallHandle(
        "g_sequence_sort",
        constants$275.g_sequence_sort$FUNC, false
    );
    ...
    static final MethodHandle g_sequence_sort_iter$MH = RuntimeHelper.downcallHandle(
        ...
        constants$275.g_sequence_sort_iter$FUNC, false
    );
}
