...
public class _GClosureNotifyData {
    ...
    public static MemoryAddress data$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GClosureNotifyData.data$VH.get(seg);
    }
    ...
    public static MemoryAddress data$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GClosureNotifyData.data$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress notify$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GClosureNotifyData.notify$VH.get(seg);
    }
    ...
    public static MemoryAddress notify$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GClosureNotifyData.notify$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static GClosureNotify notify (MemorySegment segment, ResourceScope scope) {
