...
public class _GdkEventScroll {
    ...
    public static MemoryAddress window$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventScroll.window$VH.get(seg);
    }
    ...
    public static MemoryAddress window$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventScroll.window$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress device$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventScroll.device$VH.get(seg);
    }
    ...
    public static MemoryAddress device$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GdkEventScroll.device$VH.get(seg.asSlice(index*sizeof()));
    }
