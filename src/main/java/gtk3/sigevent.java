    ...
    public static class _sigev_un {
        ...
        public static class _sigev_thread {
            ...
            static final MethodHandle _function$MH = RuntimeHelper.downcallHandle(
                _sigev_thread._function$FUNC, false
            );
            public interface _function {

                void apply(jdk.incubator.foreign.MemorySegment _x0);
                static NativeSymbol allocate(_function fi, ResourceScope scope) {
                    return RuntimeHelper.upcallStub(_function.class, fi, _sigev_thread._function$FUNC, "(Ljdk/incubator/foreign/MemorySegment;)V", scope);
                }
                static _function ofAddress(MemoryAddress addr, ResourceScope scope) {
                    NativeSymbol symbol = NativeSymbol.ofAddress("_function::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return (jdk.incubator.foreign.MemorySegment _x0) -> {
                        try {
                            _sigev_thread._function$MH.invokeExact(symbol, _x0);
                        } catch (Throwable ex$) {
            ...
            public static MemoryAddress _function$get(MemorySegment seg) {
                return (jdk.incubator.foreign.MemoryAddress)_sigev_thread._function$VH.get(seg);
            }
            ...
            public static MemoryAddress _function$get(MemorySegment seg, long index) {
                return (jdk.incubator.foreign.MemoryAddress)_sigev_thread._function$VH.get(seg.asSlice(index*sizeof()));
            }
            ...
            public static _function _function (MemorySegment segment, ResourceScope scope) {
            ...
            public static MemoryAddress _attribute$get(MemorySegment seg) {
                return (jdk.incubator.foreign.MemoryAddress)_sigev_thread._attribute$VH.get(seg);
            }
            ...
            public static MemoryAddress _attribute$get(MemorySegment seg, long index) {
                return (jdk.incubator.foreign.MemoryAddress)_sigev_thread._attribute$VH.get(seg.asSlice(index*sizeof()));
            }
