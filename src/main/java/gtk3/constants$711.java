...
class constants$711 {
    ...
    static final MethodHandle g_dbus_message_flags_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$711.g_dbus_message_flags_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_dbus_message_header_field_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$711.g_dbus_message_header_field_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_dbus_property_info_flags_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$711.g_dbus_property_info_flags_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_dbus_subtree_flags_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$711.g_dbus_subtree_flags_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_dbus_server_flags_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$711.g_dbus_server_flags_get_type$FUNC, false
    );
    ...
    static final MethodHandle g_dbus_signal_flags_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$711.g_dbus_signal_flags_get_type$FUNC, false
    );
}
