...
public class _GCompletion {
    ...
    public static MemoryAddress items$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GCompletion.items$VH.get(seg);
    }
    ...
    public static MemoryAddress items$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GCompletion.items$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress func$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GCompletion.func$VH.get(seg);
    }
    ...
    public static MemoryAddress func$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GCompletion.func$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress prefix$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GCompletion.prefix$VH.get(seg);
    }
    ...
    public static MemoryAddress prefix$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GCompletion.prefix$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress cache$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GCompletion.cache$VH.get(seg);
    }
    ...
    public static MemoryAddress cache$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GCompletion.cache$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress strncmp_func$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GCompletion.strncmp_func$VH.get(seg);
    }
    ...
    public static MemoryAddress strncmp_func$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GCompletion.strncmp_func$VH.get(seg.asSlice(index*sizeof()));
    }
