...
class constants$658 {
    ...
    static final MethodHandle g_file_open_readwrite_finish$MH = RuntimeHelper.downcallHandle(
        ...
        constants$658.g_file_open_readwrite_finish$FUNC, false
    );
    ...
    static final MethodHandle g_file_create_readwrite$MH = RuntimeHelper.downcallHandle(
        ...
        constants$658.g_file_create_readwrite$FUNC, false
    );
    ...
    static final MethodHandle g_file_create_readwrite_async$MH = RuntimeHelper.downcallHandle(
        ...
        constants$658.g_file_create_readwrite_async$FUNC, false
    );
    ...
    static final MethodHandle g_file_create_readwrite_finish$MH = RuntimeHelper.downcallHandle(
        ...
        constants$658.g_file_create_readwrite_finish$FUNC, false
    );
    ...
    static final MethodHandle g_file_replace_readwrite$MH = RuntimeHelper.downcallHandle(
        ...
        constants$658.g_file_replace_readwrite$FUNC, false
    );
    ...
    static final MethodHandle g_file_replace_readwrite_async$MH = RuntimeHelper.downcallHandle(
        ...
        constants$658.g_file_replace_readwrite_async$FUNC, false
    );
}
