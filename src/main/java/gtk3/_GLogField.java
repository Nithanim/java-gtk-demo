...
public class _GLogField {
    ...
    public static MemoryAddress key$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GLogField.key$VH.get(seg);
    }
    ...
    public static MemoryAddress key$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GLogField.key$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress value$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GLogField.value$VH.get(seg);
    }
    ...
    public static MemoryAddress value$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GLogField.value$VH.get(seg.asSlice(index*sizeof()));
    }
