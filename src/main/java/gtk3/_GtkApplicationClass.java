...
public class _GtkApplicationClass {
    ...
    static final MethodHandle window_added$MH = RuntimeHelper.downcallHandle(
        _GtkApplicationClass.window_added$FUNC, false
    );
    public interface window_added {

        void apply(jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1);
        static NativeSymbol allocate(window_added fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(window_added.class, fi, _GtkApplicationClass.window_added$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;)V", scope);
        }
        static window_added ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("window_added::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return (jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1) -> {
                try {
                    _GtkApplicationClass.window_added$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, (jdk.incubator.foreign.Addressable)_x1);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress window_added$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkApplicationClass.window_added$VH.get(seg);
    }
    ...
    public static MemoryAddress window_added$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkApplicationClass.window_added$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static window_added window_added (MemorySegment segment, ResourceScope scope) {
    ...
    static final MethodHandle window_removed$MH = RuntimeHelper.downcallHandle(
        _GtkApplicationClass.window_removed$FUNC, false
    );
    public interface window_removed {

        void apply(jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1);
        static NativeSymbol allocate(window_removed fi, ResourceScope scope) {
            return RuntimeHelper.upcallStub(window_removed.class, fi, _GtkApplicationClass.window_removed$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;)V", scope);
        }
        static window_removed ofAddress(MemoryAddress addr, ResourceScope scope) {
            NativeSymbol symbol = NativeSymbol.ofAddress("window_removed::" + Long.toHexString(addr.toRawLongValue()), addr, scope);
return (jdk.incubator.foreign.MemoryAddress _x0, jdk.incubator.foreign.MemoryAddress _x1) -> {
                try {
                    _GtkApplicationClass.window_removed$MH.invokeExact(symbol, (jdk.incubator.foreign.Addressable)_x0, (jdk.incubator.foreign.Addressable)_x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress window_removed$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkApplicationClass.window_removed$VH.get(seg);
    }
    ...
    public static MemoryAddress window_removed$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GtkApplicationClass.window_removed$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static window_removed window_removed (MemorySegment segment, ResourceScope scope) {
