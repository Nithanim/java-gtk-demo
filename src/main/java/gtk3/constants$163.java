...
class constants$163 {
    ...
    static final MethodHandle g_main_loop_unref$MH = RuntimeHelper.downcallHandle(
        "g_main_loop_unref",
        constants$163.g_main_loop_unref$FUNC, false
    );
    ...
    static final MethodHandle g_main_loop_is_running$MH = RuntimeHelper.downcallHandle(
        ...
        constants$163.g_main_loop_is_running$FUNC, false
    );
    ...
    static final MethodHandle g_main_loop_get_context$MH = RuntimeHelper.downcallHandle(
        ...
        constants$163.g_main_loop_get_context$FUNC, false
    );
    ...
    static final MethodHandle g_source_new$MH = RuntimeHelper.downcallHandle(
        "g_source_new",
        constants$163.g_source_new$FUNC, false
    );
    ...
    static final MethodHandle g_source_set_dispose_function$MH = RuntimeHelper.downcallHandle(
        ...
        constants$163.g_source_set_dispose_function$FUNC, false
    );
    ...
    static final MethodHandle g_source_ref$MH = RuntimeHelper.downcallHandle(
        "g_source_ref",
        constants$163.g_source_ref$FUNC, false
    );
}
