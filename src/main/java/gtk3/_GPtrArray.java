...
public class _GPtrArray {
    ...
    public static MemoryAddress pdata$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GPtrArray.pdata$VH.get(seg);
    }
    ...
    public static MemoryAddress pdata$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GPtrArray.pdata$VH.get(seg.asSlice(index*sizeof()));
    }
