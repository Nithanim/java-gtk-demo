...
public class _PangoAttribute {
    ...
    public static MemoryAddress klass$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoAttribute.klass$VH.get(seg);
    }
    ...
    public static MemoryAddress klass$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_PangoAttribute.klass$VH.get(seg.asSlice(index*sizeof()));
    }
