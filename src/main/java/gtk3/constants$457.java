...
class constants$457 {
    ...
    static final MethodHandle g_signal_chain_from_overridden$MH = RuntimeHelper.downcallHandle(
        ...
        constants$457.g_signal_chain_from_overridden$FUNC, false
    );
    ...
    static final MethodHandle g_signal_chain_from_overridden_handler$MH = RuntimeHelper.downcallHandle(
        ...
        constants$457.g_signal_chain_from_overridden_handler$FUNC, true
    );
    ...
    static final MethodHandle g_signal_accumulator_true_handled$MH = RuntimeHelper.downcallHandle(
        ...
        constants$457.g_signal_accumulator_true_handled$FUNC, false
    );
    ...
    static final MethodHandle g_signal_accumulator_first_wins$MH = RuntimeHelper.downcallHandle(
        ...
        constants$457.g_signal_accumulator_first_wins$FUNC, false
    );
    ...
    static final MethodHandle g_signal_handlers_destroy$MH = RuntimeHelper.downcallHandle(
        ...
        constants$457.g_signal_handlers_destroy$FUNC, false
    );
    ...
    static final MethodHandle _g_signals_destroy$MH = RuntimeHelper.downcallHandle(
        "_g_signals_destroy",
        constants$457._g_signals_destroy$FUNC, false
    );
}
