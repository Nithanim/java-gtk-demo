...
public class _AtkSocket {
    ...
    public static MemoryAddress embedded_plug_id$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkSocket.embedded_plug_id$VH.get(seg);
    }
    ...
    public static MemoryAddress embedded_plug_id$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_AtkSocket.embedded_plug_id$VH.get(seg.asSlice(index*sizeof()));
    }
