...
public class _GString {
    ...
    public static MemoryAddress str$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_GString.str$VH.get(seg);
    }
    ...
    public static MemoryAddress str$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_GString.str$VH.get(seg.asSlice(index*sizeof()));
    }
